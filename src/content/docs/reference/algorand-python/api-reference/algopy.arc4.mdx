...
__add__(other: collections.abc.Iterable[algopy.arc4._TArrayItem]) → [algopy.arc4.DynamicArray](#algopy.arc4.DynamicArray)[algopy.arc4._TArrayItem]
...
arc4_signature(signature: str | collections.abc.Callable[algopy.arc4._P, algopy.arc4._R], /) → [algopy.Bytes](/reference/algorand-python/algopy#algopy.Bytes)
