...
| [`abimethod`](#algopy.arc4.abimethod)           | Decorator that indicates a method is an ARC4 ABI method. If the method should not be externally<br/>callable, use [`algopy.subroutine()`](/reference/algorand-python/algopy#algopy.subroutine) instead.   |
|-------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
__init_subclass__(\*, name: str = ..., scratch_slots: [algopy.urange](/reference/algorand-python/algopy#algopy.urange) | tuple[int | [algopy.urange](/reference/algorand-python/algopy#algopy.urange), ...] | list[int | [algopy.urange](/reference/algorand-python/algopy#algopy.urange)] = ..., state_totals: [algopy.StateTotals](/reference/algorand-python/algopy#algopy.StateTotals) = ..., avm_version: int = ...)
...
clear_state_program() → [algopy.UInt64](/reference/algorand-python/algopy#algopy.UInt64) | bool
...
Address(value: [algopy.Account](/reference/algorand-python/algopy#algopy.Account) | str | [algopy.Bytes](/reference/algorand-python/algopy#algopy.Bytes) = ..., /)
...
__eq__(other: [algopy.arc4.Address](#algopy.arc4.Address) | [algopy.Account](/reference/algorand-python/algopy#algopy.Account) | str) → bool
...
__getitem__(index: [algopy.UInt64](/reference/algorand-python/algopy#algopy.UInt64) | int) → algopy.arc4._TArrayItem
...
__ne__(other: [algopy.arc4.Address](#algopy.arc4.Address) | [algopy.Account](/reference/algorand-python/algopy#algopy.Account) | str) → bool
...
__setitem__(index: [algopy.UInt64](/reference/algorand-python/algopy#algopy.UInt64) | int, value: algopy.arc4._TArrayItem) → algopy.arc4._TArrayItem
...
bytes *: [algopy.Bytes](/reference/algorand-python/algopy#algopy.Bytes)*
...
from_bytes(value: [algopy.Bytes](/reference/algorand-python/algopy#algopy.Bytes) | bytes, /) → Self
...
from_log(log: [algopy.Bytes](/reference/algorand-python/algopy#algopy.Bytes), /) → Self
...
length *: [algopy.UInt64](/reference/algorand-python/algopy#algopy.UInt64)*
...
native *: [algopy.Account](/reference/algorand-python/algopy#algopy.Account)*
...
BigUIntN(value: [algopy.BigUInt](/reference/algorand-python/algopy#algopy.BigUInt) | [algopy.UInt64](/reference/algorand-python/algopy#algopy.UInt64) | int = 0, /)
...
__eq__(other: [algopy.arc4.UIntN](#algopy.arc4.UIntN)[algopy.arc4._TBitSize] | [algopy.arc4.BigUIntN](#algopy.arc4.BigUIntN)[algopy.arc4._TBitSize] | [algopy.UInt64](/reference/algorand-python/algopy#algopy.UInt64) | [algopy.BigUInt](/reference/algorand-python/algopy#algopy.BigUInt) | int) → bool
...
__ge__(other: [algopy.arc4.UIntN](#algopy.arc4.UIntN)[algopy.arc4._TBitSize] | [algopy.arc4.BigUIntN](#algopy.arc4.BigUIntN)[algopy.arc4._TBitSize] | [algopy.UInt64](/reference/algorand-python/algopy#algopy.UInt64) | [algopy.BigUInt](/reference/algorand-python/algopy#algopy.BigUInt) | int) → bool
...
__gt__(other: [algopy.arc4.UIntN](#algopy.arc4.UIntN)[algopy.arc4._TBitSize] | [algopy.arc4.BigUIntN](#algopy.arc4.BigUIntN)[algopy.arc4._TBitSize] | [algopy.UInt64](/reference/algorand-python/algopy#algopy.UInt64) | [algopy.BigUInt](/reference/algorand-python/algopy#algopy.BigUInt) | int) → bool
...
__le__(other: [algopy.arc4.UIntN](#algopy.arc4.UIntN)[algopy.arc4._TBitSize] | [algopy.arc4.BigUIntN](#algopy.arc4.BigUIntN)[algopy.arc4._TBitSize] | [algopy.UInt64](/reference/algorand-python/algopy#algopy.UInt64) | [algopy.BigUInt](/reference/algorand-python/algopy#algopy.BigUInt) | int) → bool
...
__lt__(other: [algopy.arc4.UIntN](#algopy.arc4.UIntN)[algopy.arc4._TBitSize] | [algopy.arc4.BigUIntN](#algopy.arc4.BigUIntN)[algopy.arc4._TBitSize] | [algopy.UInt64](/reference/algorand-python/algopy#algopy.UInt64) | [algopy.BigUInt](/reference/algorand-python/algopy#algopy.BigUInt) | int) → bool
...
__ne__(other: [algopy.arc4.UIntN](#algopy.arc4.UIntN)[algopy.arc4._TBitSize] | [algopy.arc4.BigUIntN](#algopy.arc4.BigUIntN)[algopy.arc4._TBitSize] | [algopy.UInt64](/reference/algorand-python/algopy#algopy.UInt64) | [algopy.BigUInt](/reference/algorand-python/algopy#algopy.BigUInt) | int) → bool
...
native *: [algopy.BigUInt](/reference/algorand-python/algopy#algopy.BigUInt)*
...
Byte(value: [algopy.BigUInt](/reference/algorand-python/algopy#algopy.BigUInt) | [algopy.UInt64](/reference/algorand-python/algopy#algopy.UInt64) | int = 0, /)
...
native *: [algopy.UInt64](/reference/algorand-python/algopy#algopy.UInt64)*
...
native *: [algopy.Bytes](/reference/algorand-python/algopy#algopy.Bytes)*
...
String(value: [algopy.String](/reference/algorand-python/algopy#algopy.String) | str = '', /)
...
__eq__(other: [algopy.arc4.String](#algopy.arc4.String) | [algopy.String](/reference/algorand-python/algopy#algopy.String) | str) → bool
...
native *: [algopy.String](/reference/algorand-python/algopy#algopy.String)*
...
UIntN(value: [algopy.BigUInt](/reference/algorand-python/algopy#algopy.BigUInt) | [algopy.UInt64](/reference/algorand-python/algopy#algopy.UInt64) | int = 0, /)
...
result, txn = abi_call[arc4.String](/reference/algorand-python/hellostring)string", arc4.String("Algo"), app=...)
assert result == "Hello, Algo"

# can reference a method name, the method selector is inferred from arguments and return type
result, txn = abi_call[arc4.String](/reference/algorand-python/hello-there-app)
...
arc4_create(method: collections.abc.Callable[algopy.arc4._P, algopy.arc4._TABIResult_co], /, \*args: object, compiled: [algopy.CompiledContract](/reference/algorand-python/algopy#algopy.CompiledContract) = ..., on_completion: [algopy.OnCompleteAction](/reference/algorand-python/algopy#algopy.OnCompleteAction) = ..., fee: [algopy.UInt64](/reference/algorand-python/algopy#algopy.UInt64) | int = 0, sender: [algopy.Account](/reference/algorand-python/algopy#algopy.Account) | str = ..., note: [algopy.Bytes](/reference/algorand-python/algopy#algopy.Bytes) | bytes | str = ..., rekey_to: [algopy.Account](/reference/algorand-python/algopy#algopy.Account) | str = ...) → tuple[algopy.arc4._TABIResult_co, [algopy.itxn.ApplicationCallInnerTransaction](/reference/algorand-python/algopyitxn#algopy.itxn.ApplicationCallInnerTransaction)]
...
arc4_signature(signature: str, /) → [algopy.Bytes](/reference/algorand-python/algopy#algopy.Bytes)
...
arc4_update(method: collections.abc.Callable[algopy.arc4._P, algopy.arc4._TABIResult_co], /, \*args: object, app_id: [algopy.Application](/reference/algorand-python/algopy#algopy.Application) | [algopy.UInt64](/reference/algorand-python/algopy#algopy.UInt64) | int, compiled: [algopy.CompiledContract](/reference/algorand-python/algopy#algopy.CompiledContract) = ..., fee: [algopy.UInt64](/reference/algorand-python/algopy#algopy.UInt64) | int = 0, sender: [algopy.Account](/reference/algorand-python/algopy#algopy.Account) | str = ..., note: [algopy.Bytes](/reference/algorand-python/algopy#algopy.Bytes) | bytes | str = ..., rekey_to: [algopy.Account](/reference/algorand-python/algopy#algopy.Account) | str = ...) → tuple[algopy.arc4._TABIResult_co, [algopy.itxn.ApplicationCallInnerTransaction](/reference/algorand-python/algopyitxn#algopy.itxn.ApplicationCallInnerTransaction)]
