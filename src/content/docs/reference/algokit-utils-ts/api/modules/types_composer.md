...
slug: reference/algokit-utils-ts/api/modules/types_composer
---

[@algorandfoundation/algokit-utils](/reference/algokit-utils-ts/api/overview) / types/composer
...
Ƭ **AppUpdateParams**: [`Expand`](/reference/algokit-utils-ts/api/modules/types_expand/#expand)\<[`CommonAppCallParams`](#commonappcallparams) & \{ `approvalProgram`: `string` \| `Uint8Array` ; `clearStateProgram`: `string` \| `Uint8Array` ; `onComplete?`: `algosdk.OnApplicationComplete.UpdateApplicationOC` }\>
...
Ƭ **SimulateOptions**: [`Expand`](/reference/algokit-utils-ts/api/modules/types_expand/#expand)\<`Partial`\<[`SkipSignaturesSimulateOptions`](#skipsignaturessimulateoptions)\> & [`RawSimulateOptions`](#rawsimulateoptions)\>
...
Ƭ **SkipSignaturesSimulateOptions**: [`Expand`](/reference/algokit-utils-ts/api/modules/types_expand/#expand)\<`Omit`\<[`RawSimulateOptions`](#rawsimulateoptions), `"fixSigners"` \| `"allowEmptySignatures"`\> & \{ `skipSignatures`: `boolean` }\>
