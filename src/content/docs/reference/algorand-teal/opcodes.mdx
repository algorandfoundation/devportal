...
This page documents the current state of the AVM and may include opcode versions that have not yet been approved and adopted by all node operators.

<OpcodeFilters currentVersion="12" />
