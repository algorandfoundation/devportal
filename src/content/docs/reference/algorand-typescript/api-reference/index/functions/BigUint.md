...
[@algorandfoundation/algorand-typescript](/readme) / [index](/reference/readme) / BigUint

# Function: BigUint()

## Call Signature

> **BigUint**(`v`): [`biguint`](/reference/type-aliases/biguint)
...
> **BigUint**(): [`biguint`](/reference/type-aliases/biguint)
