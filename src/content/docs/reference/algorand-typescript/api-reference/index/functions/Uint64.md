...
[@algorandfoundation/algorand-typescript](/readme) / [index](/reference/readme) / Uint64

# Function: Uint64()

## Call Signature

> **Uint64**(): [`uint64`](/reference/type-aliases/uint64)
...
> **Uint64**(`v`): [`uint64`](/reference/type-aliases/uint64)
