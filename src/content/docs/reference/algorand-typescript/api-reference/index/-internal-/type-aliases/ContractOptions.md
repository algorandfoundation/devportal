...
[@algorandfoundation/algorand-typescript](/readme) / [index](/readme) / [\<internal\>](/reference/readme) / ContractOptions
...
> `optional` **scratchSlots**: (`number` \| [`NumberRange`](/reference/algorand-typescript/numberrange))[]
...
> `optional` **stateTotals**: [`StateTotals`](/reference/algorand-typescript/statetotals)
