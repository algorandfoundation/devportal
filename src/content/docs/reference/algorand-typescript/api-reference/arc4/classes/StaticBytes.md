...
[@algorandfoundation/algorand-typescript](/readme) / [arc4](/reference/readme) / StaticBytes
...
> **new StaticBytes**\<`TLength`\>(`value`?): [`StaticBytes`](/reference/algorand-typescript/staticbytes)\<`TLength`\>
...
[`StaticBytes`](/reference/algorand-typescript/staticbytes)\<`TLength`\>
