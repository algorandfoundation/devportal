...
[@algorandfoundation/algorand-typescript](/readme) / [arc4](/reference/readme) / UintN64
...
- [`UintN`](/reference/algorand-typescript/uintn)\<`64`\>

## Constructors

### new UintN64()

> **new UintN64**(`v`?): [`UintN64`](/reference/algorand-typescript/uintn64)
