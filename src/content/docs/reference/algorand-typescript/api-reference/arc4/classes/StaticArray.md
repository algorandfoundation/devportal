...
[@algorandfoundation/algorand-typescript](/readme) / [arc4](/reference/readme) / StaticArray
...
> **new StaticArray**\<`TItem`, `TLength`\>(): [`StaticArray`](/reference/algorand-typescript/staticarray)\<`TItem`, `TLength`\>
...
[`StaticArray`](/reference/algorand-typescript/staticarray)\<`TItem`, `TLength`\>
...
> **new StaticArray**\<`TItem`, `TLength`\>(...`items`): [`StaticArray`](/reference/algorand-typescript/staticarray)\<`TItem`, `TLength`\>
...
> **copy**(): [`StaticArray`](/reference/algorand-typescript/staticarray)\<`TItem`, `TLength`\>
