...
opt_in(algod_client: [algosdk.v2client.algod.AlgodClient](/reference/algokit-utils-py/algosdk/algosdkv2clientalgod#algosdk.v2client.algod.AlgodClient), account: [algokit_utils._legacy_v2.models.Account](/reference/algokit-utils-py/api-reference/algokit_utils_legacy_v2models#algokit_utils._legacy_v2.models.Account), asset_ids: list[int]) → dict[int, str]
...
opt_out(algod_client: [algosdk.v2client.algod.AlgodClient](/reference/algokit-utils-py/algosdk/algosdkv2clientalgod#algosdk.v2client.algod.AlgodClient), account: [algokit_utils._legacy_v2.models.Account](/reference/algokit-utils-py/api-reference/algokit_utils_legacy_v2models#algokit_utils._legacy_v2.models.Account), asset_ids: list[int]) → dict[int, str]
