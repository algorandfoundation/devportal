...
account_to_fund *: [algokit_utils.models.Account](/reference/algokit-utils-py/api-reference/algokit_utilsmodels#algokit_utils.models.Account) | [algosdk.atomic_transaction_composer.AccountTransactionSigner](/reference/algokit-utils-py/api-reference/algosdk/algosdkatomic_transaction_composer#algosdk.atomic_transaction_composer.AccountTransactionSigner) | str*
...
funding_source *: [algokit_utils.models.Account](/reference/algokit-utils-py/api-reference/algokit_utilsmodels#algokit_utils.models.Account) | [algosdk.atomic_transaction_composer.AccountTransactionSigner](/reference/algokit-utils-py/api-reference/algosdk/algosdkatomic_transaction_composer#algosdk.atomic_transaction_composer.AccountTransactionSigner) | [algokit_utils.dispenser_api.TestNetDispenserApiClient](/reference/algokit-utils-py/api-reference/algokit_utilsdispenser_api#algokit_utils.dispenser_api.TestNetDispenserApiClient) | None*
...
suggested_params *: [algosdk.transaction.SuggestedParams](/reference/algokit-utils-py/api-reference/algosdk/algosdktransaction#algosdk.transaction.SuggestedParams) | None*
