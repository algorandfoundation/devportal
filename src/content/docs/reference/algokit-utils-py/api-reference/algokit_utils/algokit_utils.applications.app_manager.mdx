...
AppManager(algod_client: [algosdk.v2client.algod.AlgodClient](/reference/algokit-utils-py/algosdk/algosdkv2clientalgod#algosdk.v2client.algod.AlgodClient))
...
compile_teal(teal_code: str) → [algokit_utils.models.application.CompiledTeal](/reference/algokit-utils-py/api-reference/algokit_utilsmodelsapplication#algokit_utils.models.application.CompiledTeal)
...
compile_teal_template(teal_template_code: str, template_params: algokit_utils.models.state.TealTemplateParams | None = None, deployment_metadata: collections.abc.Mapping[str, bool | None] | None = None) → [algokit_utils.models.application.CompiledTeal](/reference/algokit-utils-py/api-reference/algokit_utilsmodelsapplication#algokit_utils.models.application.CompiledTeal)
...
get_abi_return(confirmation: algosdk.v2client.algod.AlgodResponseType, method: algosdk.abi.Method | None = None) → [algokit_utils.applications.abi.ABIReturn](/reference/algokit-utils-py/api-reference/algokit_utilsapplicationsabi#algokit_utils.applications.abi.ABIReturn) | None
...
get_box_names(app_id: int) → list[[algokit_utils.models.state.BoxName](/reference/algokit-utils-py/api-reference/algokit_utilsmodelsstate#algokit_utils.models.state.BoxName)]
...
get_box_reference(box_id: algokit_utils.models.state.BoxIdentifier | [algokit_utils.models.state.BoxReference](/reference/algokit-utils-py/api-reference/algokit_utilsmodelsstate#algokit_utils.models.state.BoxReference)) → tuple[int, bytes]
...
get_compilation_result(teal_code: str) → [algokit_utils.models.application.CompiledTeal](/reference/algokit-utils-py/api-reference/algokit_utilsmodelsapplication#algokit_utils.models.application.CompiledTeal) | None
