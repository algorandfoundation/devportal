...
opt_in(algod_client: [algosdk.v2client.algod.AlgodClient](/reference/algokit-utils-py/api-reference/algosdk/algosdkv2clientalgod#algosdk.v2client.algod.AlgodClient), account: [algokit_utils.models.Account](/reference/algokit-utils-py/api-reference/algokit_utilsmodels#algokit_utils.models.Account), asset_ids: list[int]) → dict[int, str]
...
opt_out(algod_client: [algosdk.v2client.algod.AlgodClient](/reference/algokit-utils-py/api-reference/algosdk/algosdkv2clientalgod#algosdk.v2client.algod.AlgodClient), account: [algokit_utils.models.Account](/reference/algokit-utils-py/api-reference/algokit_utilsmodels#algokit_utils.models.Account), asset_ids: list[int]) → dict[int, str]
