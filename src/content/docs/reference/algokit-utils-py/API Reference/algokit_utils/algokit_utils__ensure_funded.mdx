...
account_to_fund *: [algokit_utils.models.Account](/reference/algokit-utils-py/API Reference/algokit_utils.models.mdx#algokit_utils.models.Account) | [algosdk.atomic_transaction_composer.AccountTransactionSigner](/reference/algokit-utils-py/algosdk/algosdk.atomic_transaction_composer.mdx#algosdk.atomic_transaction_composer.AccountTransactionSigner) | str*
...
funding_source *: [algokit_utils.models.Account](/reference/algokit-utils-py/API Reference/algokit_utils.models.mdx#algokit_utils.models.Account) | [algosdk.atomic_transaction_composer.AccountTransactionSigner](/reference/algokit-utils-py/algosdk/algosdk.atomic_transaction_composer.mdx#algosdk.atomic_transaction_composer.AccountTransactionSigner) | [algokit_utils.dispenser_api.TestNetDispenserApiClient](/reference/algokit-utils-py/API Reference/algokit_utils.dispenser_api.mdx#algokit_utils.dispenser_api.TestNetDispenserApiClient) | None*
...
suggested_params *: [algosdk.transaction.SuggestedParams](/reference/algokit-utils-py/algosdk/algosdk.transaction.mdx#algosdk.transaction.SuggestedParams) | None*
