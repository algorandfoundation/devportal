...
get_arc56_value(method: [algokit_utils.applications.app_spec.arc56.Method](/reference/algokit-utils-py/API Reference/algokit_utils.applications.app_spec.arc56#algokit_utils.applications.app_spec.arc56.Method) | [algosdk.abi.method.Method](/reference/algokit-utils-py/algosdk/algosdk.abi.method#algosdk.abi.method.Method), structs: dict[str, list[[algokit_utils.applications.app_spec.arc56.StructField](/reference/algokit-utils-py/API Reference/algokit_utils.applications.app_spec.arc56#algokit_utils.applications.app_spec.arc56.StructField)]]) → algokit_utils.applications.abi.Arc56ReturnValueType
...
method *: [algosdk.abi.method.Method](/reference/algokit-utils-py/algosdk/algosdk.abi.method#algosdk.abi.method.Method) | None*
...
name *: [algokit_utils.models.state.BoxName](/reference/algokit-utils-py/API Reference/algokit_utils.models.state#algokit_utils.models.state.BoxName)*
...
get_abi_encoded_value(value: Any, type_str: str, structs: dict[str, list[[algokit_utils.applications.app_spec.arc56.StructField](/reference/algokit-utils-py/API Reference/algokit_utils.applications.app_spec.arc56#algokit_utils.applications.app_spec.arc56.StructField)]]) → bytes
