...
persist_sourcemaps(\*, sources: list[algokit_utils._debugging.PersistSourceMapInput], project_root: pathlib.Path, client: [algosdk.v2client.algod.AlgodClient](/reference/algokit-utils/py/algosdk/algosdk.v2client.algod.mdx#algosdk.v2client.algod.AlgodClient), with_sources: bool = True) → None
...
simulate_response(atc: [algosdk.atomic_transaction_composer.AtomicTransactionComposer](/reference/algokit-utils/py/algosdk/algosdk.atomic_transaction_composer.mdx#algosdk.atomic_transaction_composer.AtomicTransactionComposer), algod_client: [algosdk.v2client.algod.AlgodClient](/reference/algokit-utils/py/algosdk/algosdk.v2client.algod.mdx#algosdk.v2client.algod.AlgodClient)) → algosdk.atomic_transaction_composer.SimulateAtomicTransactionResponse
