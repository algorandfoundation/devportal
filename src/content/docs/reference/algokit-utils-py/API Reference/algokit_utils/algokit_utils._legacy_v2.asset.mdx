---
title: "algokit_utils._legacy_v2.asset"
---

<a id="module-algokit_utils._legacy_v2.asset"></a>

<a id="algokit-utils-legacy-v2-asset"></a>
...
<a id="algokit_utils._legacy_v2.asset.ValidationType"></a>

## *class* algokit_utils._legacy_v2.asset.ValidationType
...
<a id="algokit_utils._legacy_v2.asset.ValidationType.__dir__"></a>
...
<a id="algokit_utils._legacy_v2.asset.ValidationType.__format__"></a>
...
<a id="algokit_utils._legacy_v2.asset.ValidationType.__hash__"></a>
...
<a id="algokit_utils._legacy_v2.asset.ValidationType.__reduce_ex__"></a>
...
<a id="algokit_utils._legacy_v2.asset.ValidationType.__repr__"></a>
...
<a id="algokit_utils._legacy_v2.asset.ValidationType.__str__"></a>
...
<a id="algokit_utils._legacy_v2.asset.ValidationType.name"></a>
...
<a id="algokit_utils._legacy_v2.asset.ValidationType.value"></a>
...
<a id="algokit_utils._legacy_v2.asset.opt_in"></a>

## algokit_utils._legacy_v2.asset.opt_in

opt_in(algod_client: [algosdk.v2client.algod.AlgodClient](/reference/algokit-utils-py/algosdk/algosdk.v2client.algod#algosdk.v2client.algod.AlgodClient), account: [algokit_utils._legacy_v2.models.Account](/reference/algokit-utils-py/API Reference/algokit_utils._legacy_v2.models#algokit_utils._legacy_v2.models.Account), asset_ids: list[int]) → dict[int, str]
...
<a id="algokit_utils._legacy_v2.asset.opt_out"></a>

## algokit_utils._legacy_v2.asset.opt_out

opt_out(algod_client: [algosdk.v2client.algod.AlgodClient](/reference/algokit-utils-py/algosdk/algosdk.v2client.algod#algosdk.v2client.algod.AlgodClient), account: [algokit_utils._legacy_v2.models.Account](/reference/algokit-utils-py/API Reference/algokit_utils._legacy_v2.models#algokit_utils._legacy_v2.models.Account), asset_ids: list[int]) → dict[int, str]
