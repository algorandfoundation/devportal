...
opt_in(algod_client: [algosdk.v2client.algod.AlgodClient](../algosdk/algosdk.v2client.algod.mdx#algosdk.v2client.algod.AlgodClient), account: [algokit_utils._legacy_v2.models.Account](algokit_utils._legacy_v2.models.mdx#algokit_utils._legacy_v2.models.Account), asset_ids: list[int]) → dict[int, str]
...
opt_out(algod_client: [algosdk.v2client.algod.AlgodClient](../algosdk/algosdk.v2client.algod.mdx#algosdk.v2client.algod.AlgodClient), account: [algokit_utils._legacy_v2.models.Account](algokit_utils._legacy_v2.models.mdx#algokit_utils._legacy_v2.models.Account), asset_ids: list[int]) → dict[int, str]
