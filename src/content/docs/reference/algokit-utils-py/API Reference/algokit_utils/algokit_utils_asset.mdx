...
opt_in(algod_client: [algosdk.v2client.algod.AlgodClient](/reference/algokit-utils-py/algosdk/algosdk.v2client.algod#algosdk.v2client.algod.AlgodClient), account: [algokit_utils.models.Account](/reference/algokit-utils-py/API Reference/algokit_utils.models#algokit_utils.models.Account), asset_ids: list[int]) → dict[int, str]
...
opt_out(algod_client: [algosdk.v2client.algod.AlgodClient](/reference/algokit-utils-py/algosdk/algosdk.v2client.algod#algosdk.v2client.algod.AlgodClient), account: [algokit_utils.models.Account](/reference/algokit-utils-py/API Reference/algokit_utils.models#algokit_utils.models.Account), asset_ids: list[int]) → dict[int, str]
