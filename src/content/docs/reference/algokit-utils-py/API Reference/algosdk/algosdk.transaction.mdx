...
create_dryrun(client: [algosdk.v2client.algod.AlgodClient](/reference/algokit-utils-py/API Reference/algosdk.v2client.algod#algosdk.v2client.algod.AlgodClient), txns: List[algosdk.transaction.GenericSignedTransaction], protocol_version=None, latest_timestamp=None, round=None) → algosdk.v2client.models.DryrunRequest
...
wait_for_confirmation(algod_client: [algosdk.v2client.algod.AlgodClient](/reference/algokit-utils-py/API Reference/algosdk.v2client.algod#algosdk.v2client.algod.AlgodClient), txid: str, wait_rounds: int = 0, \*\*kwargs)
