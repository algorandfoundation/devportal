...
ArrayStaticType(arg_type: [algosdk.abi.base_type.ABIType](/reference/algokit-utils-py/API Reference/algosdk.abi.base_type#algosdk.abi.base_type.ABIType), array_len: int)
...
from_string(s: str) → [algosdk.abi.base_type.ABIType](/reference/algokit-utils-py/API Reference/algosdk.abi.base_type#algosdk.abi.base_type.ABIType)
