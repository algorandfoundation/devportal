...
|---|---|---|---|---|
|application-id|path|integer|true|An application identifier.|
|max|query|integer(uint64)|false|Max number of box names to return. If max is not set, or max == 0, returns all box-names.|
...
|min-balance|integer(uint64)|true|none|MicroAlgo balance required by the account.<br><br>The requirement grows based on asset and application usage.|
...
|build_number|integer|true|none|none|
...
### TransactionProof
<!-- backwards compatibility -->
<a id="schematransactionproof"></a>
<a id="schema_TransactionProof"></a>
<a id="tocStransactionproof"></a>
<a id="tocstransactionproof"></a>
...
|idx|integer(uint64)|true|none|Index of the transaction in the block's payset.|
...
|treedepth|integer(uint64)|true|none|Represents the depth of the tree that is being proven, i.e. the number of edges from a leaf to the root.|
