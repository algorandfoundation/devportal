...
<CardGrid>
  <LinkCard
    ...
    href='/getting-started/tutorials/get-ready-to-build'
  ...
  <LinkCard
    ...
    description='Docs for AlgoKit tools — CLI (Command Line Interface), Lora, smart contract languages, and code libraries.'
  />
  <LinkCard
  ...
  <LinkCard
    ...
    description='API reference docs, ARC standards (Algorand Request for Comment), and specifications for Algorand tools and libraries.'
  />
</CardGrid>

## Build with AI

The Algorand developer ecosystem provides AI tools that help you code faster, find answers instantly, and follow best practices. Whether you prefer chatting in the browser or using an AI assistant in your IDE (Intergrated Development Environment), there are options for you.
