...
To use LORA directly, you can use the hosted version at https://lora.algokit.io/, or if you have [AlgoKit Installed](/getting-started/tutorials/get-ready-to-build#install-algokit), LORA can be launched from the CLI (Command Line Interface) by running the following command:
