...
On the default LocalNet, new blocks are only produced when transactions are submitted. If the network is idle, the explorer may appear quiet.
...
Now that you know how to open LORA, connect a LocalNet account, and navigate the main tools, you are ready to start building.
