...
In the [Getting Ready To Build]() section you initialized a new AlgoKit project and chose the Hello World smart contract template. This guide returns to that contract and shows you how to deploy and interact with it.

By the end, you will:

- Compile a smart contract
- Deploy a smart contract 
- Interact with a smart contract with LORA

## Run the Demo Application

<Tabs syncKey="lang">
    <TabItem label="TypeScript" icon="seti:typescript">
        You will notice in the `smart_contracts/hello_world` folder a file named `deploy_config.ts` which is a simple example of using AlgoKit to deploy the `HelloWorld` smart contract in `contract.algo.ts` on the Local Algorand blockchain started earlier and then call the `hello` method.
