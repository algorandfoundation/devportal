...
<Tabs syncKey="lang">
    <TabItem label="TypeScript" icon="seti:typescript">
        ...
        - [Native TEAL (Transaction Execution Approval Language) smart contract code](/concepts/smart-contracts/languages/teal): `HelloWorld.approval.teal`, `HelloWorld.clear.teal`
        - [Contract ABI](/concepts/smart-contracts/abi) (Application Binary Interface): `HelloWorld.arc56.json`
        ...
        Tools like [LORA](https://lora.algokit.io/localnet) and [goal](/docs/algokit-cli/python/latest/features/goal/) can use these artifacts to deploy and interact with your smart contract across Algorand networks.
    </TabItem>
    <TabItem label="Python" icon="seti:python">
        ...
        The App ID of the deployed contract is displayed, followed by the message returned from the smart contract call.
