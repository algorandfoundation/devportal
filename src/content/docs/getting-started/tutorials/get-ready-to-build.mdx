...
<Steps>
  ...
  1. `algorandPython.languageServer.enable`: Enables the Algorand Python language server. By
...
<Tabs syncKey="lang">
        ...
        For this guide, we will use the TypeScript smart contract starter template.
            ...
            <Steps>
                ...
                2. Next, AlgoKit will ask you what programming language you want to use for the smart contract. Let's select **TypeScript** as our smart contract language by pressing Enter. 
                     <Figure src={algokitInitTs1} alt="AlgoKit Init: Select smart contract language" />
    ...
    <TabItem label="Python" icon="seti:python">
        ...
        <Steps>
            ...
            2. Next, AlgoKit will ask you what programming language you want to use for the smart contract. Let's select **Python** as our smart contract language by pressing Enter. 
               <Figure src={algokitInitPy2} alt="AlgoKit Init: Select smart contract language" />
