...
To see some usage examples check out the [automated tests](src/types/amount.spec.ts). Alternatively, you see the [reference documentation](docs/code/classes/types_amount.AlgoAmount) for `AlgoAmount`.
