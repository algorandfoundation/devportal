...
To see some usage examples check out the [automated tests](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/types/amount.spec.ts). Alternatively, you see the [reference documentation](/reference/algokit-utils-ts/api/classes/types_amountalgoamount/) for `AlgoAmount`.
