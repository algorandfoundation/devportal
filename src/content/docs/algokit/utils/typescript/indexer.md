...
To see some usage examples check out the [automated tests](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/indexer-lookup.spec.ts).
...
- [`indexer.lookupTransactionById(transactionId, algorand.client.indexer)`](/reference/algokit-utils-ts/api/modules/index/#lookuptransactionbyid) - Finds a transaction by ID
- [`indexer.lookupAccountByAddress(accountAddress, algorand.client.indexer)`](/reference/algokit-utils-ts/api/modules/index/#lookupaccountbyaddress) - Finds an account by address
- [`indexer.lookupAccountCreatedApplicationByAddress(algorand.client.indexer, address, getAll?, paginationLimit?)`](/reference/algokit-utils-ts/api/modules/index/#lookupaccountcreatedapplicationbyaddress) - Finds all applications created for an account
- [`indexer.lookupAssetHoldings(algorand.client.indexer, assetId, options?, paginationLimit?)`](/reference/algokit-utils-ts/api/modules/index/#lookupassetholdings) - Finds all asset holdings for the given asset
- [`indexer.searchTransactions(algorand.client.indexer, searchCriteria, paginationLimit?)`](/reference/algokit-utils-ts/api/modules/index/#searchtransactions) - Search for transactions with a given set of criteria
- [`indexer.executePaginatedRequest(extractItems, buildRequest)`](/reference/algokit-utils-ts/api/modules/index/#executepaginatedrequest) - Execute the given indexer request with automatic pagination
