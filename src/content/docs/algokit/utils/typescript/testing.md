...
The testing capability is not exposed from the [root algokit module](../code/modules/) so there is a clear separation between testing functionality and non-testing functionality.
