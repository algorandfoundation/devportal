...
- `logger`: A custom logger to use. Defaults to [`algokit_utils.config.AlgoKitLogger`](docs/markdown/autoapi/algokit_utils/config/#algokit_utils.config.AlgoKitLogger) instance.
