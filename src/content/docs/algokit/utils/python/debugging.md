...
- `logger`: A custom logger to use. Defaults to [`algokit_utils.config.AlgoKitLogger`](/algokit/utils/autoapi/algokit_utils/config/index#algokit_utils.config.AlgoKitLogger) instance.
