...
When an error is thrown then the resulting error that is re-thrown will be a [`LogicError`](/algokit/utils/autoapi/algokit_utils/errors/logic_error/index#algokit_utils.errors.logic_error.LogicError), which has the following fields:
