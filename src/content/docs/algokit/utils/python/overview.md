...
- [API Reference](docs/markdown/autoapi/)
  - [algokit_utils](docs/markdown/autoapi/algokit_utils/)
...
To configure the AlgoKit Utils library you can make use of the [`Config`](docs/markdown/autoapi/algokit_utils/config/) object, which has a configure method that lets you configure some or all of the configuration options.

## Config singleton

The AlgoKit Utils configuration singleton can be updated using `config.configure()`. Refer to the [Config API documentation](docs/markdown/autoapi/algokit_utils/config/) for more details.

## Logging

AlgoKit has an in-built logging abstraction through the [`algokit_utils.config.AlgoKitLogger`](docs/markdown/autoapi/algokit_utils/config/#algokit_utils.config.AlgoKitLogger) class that provides standardized logging capabilities. The logger is accessible through the `config.logger` property and provides various logging levels.
...
For detailed API documentation, see the [`algokit_utils`](docs/markdown/autoapi/algokit_utils/#module-algokit_utils)
