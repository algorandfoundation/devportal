...
[Template Variables](docs/_build/markdown/api-algopy#algopy.TemplateVar), can be replaced with literal values during compilation to bytecode using the `--template-var` option.
Additionally, Algorand Python functions that create AVM bytecode, such as [compile_contract](docs/_build/markdown/api-algopy#algopy.compile_contract) and [compile_logicsig](docs/_build/markdown/api-algopy#algopy.compile_logicsig), can also provide the specified values.
...
| ------------------------------------------------------- | -------------------------------------------------------------- | ------------------------ |
| [UInt64](docs/_build/markdown/api-algopy#algopy.UInt64) | `algopy.TemplateVar[UInt64](docs/_build/markdown/"SOME_INT")`  | `SOME_INT=1234`          |
| [Bytes](docs/_build/markdown/api-algopy#algopy.Bytes)   | `algopy.TemplateVar[Bytes](docs/_build/markdown/"SOME_BYTES")` | `SOME_BYTES=0x1A2B`      |
| [String](docs/_build/markdown/api-algopy#algopy.String) | `algopy.TemplateVar[String](docs/_build/markdown/"SOME_STR")`  | `SOME_STR="hello"`       |
