...
- Smart Contract Templates:
  ...
  - [Algorand TypeScript](https://github.com/algorandfoundation/algokit-typescript-template)
...
<Steps>
1. [Install AlgoKit](/getting-started/tutorials/get-ready-to-build) and all the prerequisites mentioned in the installation guide.
...
[Algorand TypeScript Smart Contract Template Github Repo](https://github.com/algorandfoundation/algokit-typescript-template)
...
To use it [install AlgoKit](https://github.com/algorandfoundation/algokit-cli#readme) and then either pass in `-t typescript` to `algokit init` or select the `TypeScript` language option interactively during `algokit init.`
...
:::caution[Do not use the `tealscript` template]
`algokit init -t tealscript` still resolves, but it scaffolds a [TEALScript](https://github.com/algorandfoundation/tealscript) project. TEALScript is deprecated and receives no further development. Use `-t typescript` for new TypeScript smart contract projects, and see the [TEALScript to Algorand TypeScript migration guide](/docs/algorand-typescript/typescript/latest/migration-guides) for existing ones.
:::
...
- [Instructions for Starter template](https://github.com/algorandfoundation/algokit-typescript-template/blob/main/examples/starter/README.md)
- [Instructions for Production template](https://github.com/algorandfoundation/algokit-typescript-template/blob/main/examples/production/README.md)
