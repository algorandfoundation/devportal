...
titleImageDark: '/title-img/algokit-logo-dark.svg'
titleImageLight: '/title-img/algokit-logo-light.svg'
---
...
<YouTube id='pojEI-8h0lg' title='Introduction to AlgoKit' />
...
<LinkCard
  ...
  href='/docs/algokit-cli/python/latest/'
...
<LinkCard
  ...
  href='/docs/algokit-utils/typescript/latest/'
...
<LinkCard
  ...
  href='/docs/algokit-utils/python/latest/'
  description='Learn more about the design and implementation of Algorand Utils'
/>
<LinkCard
...
<YouTube id='AkUj1GgcMig' title='Introduction to Algokit Utils' />
...
<LinkCard
  ...
  href='/docs/algokit-cli/python/latest/features/localnet'
...
<LinkCard
  title='Algokit TypeScript Language Server'
  href='/algokit/language-servers/algorand-typescript'
  description='Learn more about the TypeScript Language Server'
/>
<LinkCard
  title='Algokit Python Langauge Server'
  href='/algokit/language-servers/algorand-python'
  description='Learn more about the Python Language Server'
/>
...
<LinkCard
  ...
  href='/docs/algokit-utils/typescript/latest/concepts/advanced/dispenser-client'
...
- **Node.js**: For those working on frontend templates or building contracts using Algorand TypeScript. **Minimum required versions are Node.js `v22` and npm `v10`**. See [Node.js Installation](https://nodejs.org/en/download/).
