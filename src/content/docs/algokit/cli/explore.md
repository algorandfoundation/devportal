...
---
AlgoKit provides a quick shortcut to [explore](/docs/algokit-cli/python/latest/#explore) various Algorand networks using [lora](https://lora.algokit.io/) including [AlgoKit LocalNet](/algokit/cli/localnet/)!
