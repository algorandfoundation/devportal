...
Git is a prerequisite for the init command as it is used to clone templates and initialize git repos. Please consult the [README](/algokit/algokit-intro#prerequisites) for installation instructions.
