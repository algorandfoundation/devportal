...
For more details, refer to [Debugger](/docs/algokit-utils/python/latest/guides/debugging):
...
To learn more, refer to documentation of the [debugger extension](/docs/algokit-utils/python/latest/guides/debugging) to learn more about Debugging session.
