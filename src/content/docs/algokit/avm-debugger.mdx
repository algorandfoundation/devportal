...
<YouTube id='yPWRlmmTSHA' title='Debugging with AlgoKit 3.0' />
...
For more details, refer to [Debugger](/docs/algokit-utils/python/latest/guides/concepts/advanced/debugging):
...
To learn more, refer to documentation of the [debugger extension](/docs/algokit-utils/python/latest/guides/concepts/advanced/debugging) to learn more about Debugging session.
