---
title: Algorand TypeScript Language Server
sidebar:
...
If you haven't installed algokit, follow these [steps](/getting-started/tutorials/get-ready-to-build).

<LinkCard
  title='Create Algokit project'
  href='/getting-started/tutorials/get-ready-to-build#create-an-algokit-project'
