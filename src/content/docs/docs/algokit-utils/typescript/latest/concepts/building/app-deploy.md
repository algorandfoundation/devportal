...
App deployment is a higher-order use case capability provided by AlgoKit Utils that builds on top of the core capabilities, particularly [App management](/docs/algokit-utils/typescript/latest/concepts/building/app/).
...
![App deployment lifecycle](/docs/algokit-utils/typescript/latest/concepts/images/lifecycle.jpg)
...
To get an instance of `AppDeployer` you can use either [`AlgorandClient`](/docs/algokit-utils/typescript/latest/concepts/core/algorand-client/) via `algorand.appDeployer` or instantiate it directly (passing in an [`AppManager`](/docs/algokit-utils/typescript/latest/concepts/building/app/#appmanager), [`AlgorandClientTransactionSender`](/docs/algokit-utils/typescript/latest/concepts/core/algorand-client/#sending-a-single-transaction) and optionally an indexer client instance):
...
- `createParams: AppCreateParams | AppCreateMethodCall` - the parameters for an [app creation call](/docs/algokit-utils/typescript/latest/concepts/building/app/#creation) (raw or ABI method call)
- `updateParams: Omit<AppUpdateParams | AppUpdateMethodCall, 'appId' | 'approvalProgram' | 'clearStateProgram'>` - the parameters for an [app update call](/docs/algokit-utils/typescript/latest/concepts/building/app/#updating) (raw or ABI method call) without the `appId`, `approvalProgram` or `clearStateProgram`, since these are calculated by the `deploy` method
- `deleteParams: Omit<AppDeleteParams | AppDeleteMethodCall, 'appId'>` - the parameters for an [app delete call](/docs/algokit-utils/typescript/latest/concepts/building/app/#deleting) (raw or ABI method call) without the `appId`, since this is calculated by the `deploy` method
...
- Everything from `SendParams` - [transaction execution control parameters](/docs/algokit-utils/typescript/latest/concepts/building/algorand-client/#transaction-parameters)
...
def update(self) -> None:
    assert TemplateVar[bool](/docs/algokit-utils/typescript/latest/concepts/building/app-deploy/"updatable"/)

@arc4.baremethod(allow_actions=["DeleteApplication"])
def delete(self) -> None:
    assert TemplateVar[bool](/docs/algokit-utils/typescript/latest/concepts/building/app-deploy/"deletable"/)
# ... your contract code ...
```
...
- If `create`, `update` or `replace` then it will have the relevant [`SendAppTransactionResult`](/docs/algokit-utils/typescript/latest/concepts/building/app/#calling-an-app) values
- If `replace` then it will also have `{deleteReturn?: ABIReturn, deleteResult: ConfirmedTransactionResult}` to capture the [result](/docs/algokit-utils/typescript/latest/concepts/core/algorand-client/#sending-a-single-transaction) of the deletion of the existing app
