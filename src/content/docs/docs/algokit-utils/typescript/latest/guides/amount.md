...
To see some usage examples check out the [automated tests](src/types/amount.spec.ts). Alternatively, you see the [reference documentation](/docs/algokit-utils/typescript/latest/api/classes/types_amountalgoamount/) for `AlgoAmount`.
