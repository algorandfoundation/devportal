...
The base type for specifying an asset creation transaction is [`AssetCreateParams`](/docs/algokit-utils/typescript/latest/api/modules/types_composer/#assetcreateparams), which has the following parameters in addition to the [common transaction parameters](/docs/algokit-utils/typescript/latest/guides/algorand-client/#transaction-parameters):
...
The base type for specifying an asset creation transaction is [`AssetConfigParams`](/docs/algokit-utils/typescript/latest/api/modules/types_composer/#assetconfigparams), which has the following parameters in addition to the [common transaction parameters](/docs/algokit-utils/typescript/latest/guides/algorand-client/#transaction-parameters):
...
The base type for specifying an asset transfer transaction is [`AssetTransferParams`](/docs/algokit-utils/typescript/latest/api/modules/types_composer/#assettransferparams), which has the following parameters in addition to the [common transaction parameters](/docs/algokit-utils/typescript/latest/guides/algorand-client/#transaction-parameters):
...
The base type for specifying an asset opt-in transaction is [`AssetOptInParams`](/docs/algokit-utils/typescript/latest/api/modules/types_composer/#assetoptinparams), which has the following parameters in addition to the [common transaction parameters](/docs/algokit-utils/typescript/latest/guides/algorand-client/#transaction-parameters):
...
The base type for specifying an asset opt-out transaction is [`AssetOptOutParams`](/docs/algokit-utils/typescript/latest/api/modules/types_composer/#assetoptoutparams), which has the following parameters in addition to the [common transaction parameters](/docs/algokit-utils/typescript/latest/guides/algorand-client/#transaction-parameters):
