...
- [`indexer.lookupTransactionById(transactionId, algorand.client.indexer)`](/docs/algokit-utils/typescript/latest/api/modules/#lookuptransactionbyid) - Finds a transaction by ID
- [`indexer.lookupAccountByAddress(accountAddress, algorand.client.indexer)`](/docs/algokit-utils/typescript/latest/api/modules/#lookupaccountbyaddress) - Finds an account by address
- [`indexer.lookupAccountCreatedApplicationByAddress(algorand.client.indexer, address, getAll?, paginationLimit?)`](/docs/algokit-utils/typescript/latest/api/modules/#lookupaccountcreatedapplicationbyaddress) - Finds all applications created for an account
- [`indexer.lookupAssetHoldings(algorand.client.indexer, assetId, options?, paginationLimit?)`](/docs/algokit-utils/typescript/latest/api/modules/#lookupassetholdings) - Finds all asset holdings for the given asset
- [`indexer.searchTransactions(algorand.client.indexer, searchCriteria, paginationLimit?)`](/docs/algokit-utils/typescript/latest/api/modules/#searchtransactions) - Search for transactions with a given set of criteria
- [`indexer.executePaginatedRequest(extractItems, buildRequest)`](/docs/algokit-utils/typescript/latest/api/modules/#executepaginatedrequest) - Execute the given indexer request with automatic pagination
