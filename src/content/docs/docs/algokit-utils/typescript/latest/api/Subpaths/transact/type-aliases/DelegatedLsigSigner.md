...
> **DelegatedLsigSigner** = (`lsig`, `msig?`) => `Promise`\<`object` & \{ `sig?`: `Uint8Array`; \} \| \{ `lmsig?`: [`MultisigSignature`](/algokit-utils-ts/api/subpaths/transact/type-aliases/multisigsignature/); \}\>
...
`Promise`\<`object` & \{ `sig?`: `Uint8Array`; \} \| \{ `lmsig?`: [`MultisigSignature`](/algokit-utils-ts/api/subpaths/transact/type-aliases/multisigsignature/); \}\>
