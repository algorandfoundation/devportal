...
Defined in: [packages/indexer\_client/src/apis/api-service.ts:43](https://github.com/larkiny/algokit-utils-ts/blob/main/packages/indexer_client/src/apis/api-service.ts#L43)
