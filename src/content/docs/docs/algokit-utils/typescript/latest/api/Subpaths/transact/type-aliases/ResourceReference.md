...
> `optional` **box**: [`BoxReference`](/algokit-utils-ts/api/subpaths/transact/type-aliases/boxreference/)
...
> `optional` **holding**: [`HoldingReference`](/algokit-utils-ts/api/subpaths/transact/type-aliases/holdingreference/)
...
> `optional` **locals**: [`LocalsReference`](/algokit-utils-ts/api/subpaths/transact/type-aliases/localsreference/)
