...
> `optional` **assetHolding**: [`AssetHolding`](/algokit-utils-ts/api/subpaths/algod-client/type-aliases/assetholding/)
...
> `optional` **createdAsset**: [`AssetParams`](/algokit-utils-ts/api/subpaths/algod-client/type-aliases/assetparams/)
