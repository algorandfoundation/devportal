...
> **DeployAppUpdateParams** = `Expand`\<`Omit`\<[`AppUpdateParams`](/algokit-utils-ts/api/algokit-utils/type-aliases/appupdateparams/), `"appId"` \| `"approvalProgram"` \| `"clearStateProgram"`\>\>
