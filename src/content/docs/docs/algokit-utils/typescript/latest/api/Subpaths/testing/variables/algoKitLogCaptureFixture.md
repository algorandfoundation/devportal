...
> `const` **algoKitLogCaptureFixture**: () => [`AlgoKitLogCaptureFixture`](/algokit-utils-ts/api/subpaths/testing/interfaces/algokitlogcapturefixture/)
...
[`AlgoKitLogCaptureFixture`](/algokit-utils-ts/api/subpaths/testing/interfaces/algokitlogcapturefixture/)
