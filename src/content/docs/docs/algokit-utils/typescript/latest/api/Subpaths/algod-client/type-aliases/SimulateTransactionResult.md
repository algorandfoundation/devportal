...
> `optional` **execTrace**: [`SimulationTransactionExecTrace`](/algokit-utils-ts/api/subpaths/algod-client/type-aliases/simulationtransactionexectrace/)
...
> `optional` **fixedSigner**: [`Address`](/algokit-utils-ts/api/algokit-utils/classes/address/)
...
> **txnResult**: [`PendingTransactionResponse`](/algokit-utils-ts/api/subpaths/algod-client/type-aliases/pendingtransactionresponse/)
...
> `optional` **unnamedResourcesAccessed**: [`SimulateUnnamedResourcesAccessed`](/algokit-utils-ts/api/subpaths/algod-client/type-aliases/simulateunnamedresourcesaccessed/)
