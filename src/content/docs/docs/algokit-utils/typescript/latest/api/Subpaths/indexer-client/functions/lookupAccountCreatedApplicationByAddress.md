...
> **lookupAccountCreatedApplicationByAddress**(`indexer`, `address`, `getAll`, `paginationLimit?`): `Promise`\<[`Application`](/algokit-utils-ts/api/subpaths/indexer-client/type-aliases/application/)[]\>
...
`Promise`\<[`Application`](/algokit-utils-ts/api/subpaths/indexer-client/type-aliases/application/)[]\>
