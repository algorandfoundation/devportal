...
Defined in: [packages/transact/src/transactions/state-proof.ts:15](https://github.com/larkiny/algokit-utils-ts/blob/main/packages/transact/src/transactions/state-proof.ts#L15)
...
> **partProofs**: [`MerkleArrayProof`](/docs/algokit-utils/typescript/latest/api/subpaths/transact/type-aliases/merklearrayproof/)
...
> **reveals**: `Map`\<`bigint`, [`Reveal`](/docs/algokit-utils/typescript/latest/api/subpaths/transact/type-aliases/reveal/)\>
...
> **sigProofs**: [`MerkleArrayProof`](/docs/algokit-utils/typescript/latest/api/subpaths/transact/type-aliases/merklearrayproof/)

Defined in: [packages/transact/src/transactions/state-proof.ts:18](https://github.com/larkiny/algokit-utils-ts/blob/main/packages/transact/src/transactions/state-proof.ts#L18)
