...
Defined in: [src/client-manager.ts:713](https://github.com/larkiny/algokit-utils-ts/blob/main/src/client-manager.ts#L713)

#### Parameters

##### params

`Omit`\<[`AppFactoryParams`](/docs/algokit-utils/typescript/latest/api/algokit-utils/interfaces/appfactoryparams/), `"appSpec"`\>
