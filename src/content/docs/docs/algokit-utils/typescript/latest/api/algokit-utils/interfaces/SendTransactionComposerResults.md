...
- `Omit`\<[`SendTransactionResults`](/algokit-utils-ts/api/algokit-utils/interfaces/sendtransactionresults/), `"confirmations"`\>
...
> `optional` **returns**: [`ABIReturn`](/algokit-utils-ts/api/subpaths/abi/type-aliases/abireturn/)[]
