...
> `optional` **appLocalState**: [`ApplicationLocalState`](/algokit-utils-ts/api/subpaths/algod-client/type-aliases/applicationlocalstate/)
...
> `optional` **createdApp**: [`ApplicationParams`](/algokit-utils-ts/api/subpaths/algod-client/type-aliases/applicationparams/)
