...
> `optional` **evalOverrides**: [`SimulationEvalOverrides`](/algokit-utils-ts/api/subpaths/algod-client/type-aliases/simulationevaloverrides/)
...
> `optional` **execTraceConfig**: [`SimulateTraceConfig`](/algokit-utils-ts/api/subpaths/algod-client/type-aliases/simulatetraceconfig/)
...
> `optional` **initialStates**: [`SimulateInitialStates`](/algokit-utils-ts/api/subpaths/algod-client/type-aliases/simulateinitialstates/)
...
> **txnGroups**: [`SimulateTransactionGroupResult`](/algokit-utils-ts/api/subpaths/algod-client/type-aliases/simulatetransactiongroupresult/)[]
