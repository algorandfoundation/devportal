...
> `optional` **scratchChanges**: [`ScratchChange`](/algokit-utils-ts/api/subpaths/algod-client/type-aliases/scratchchange/)[]
...
> `optional` **stackAdditions**: [`AvmValue`](/algokit-utils-ts/api/subpaths/algod-client/type-aliases/avmvalue/)[]
...
> `optional` **stateChanges**: [`ApplicationStateOperation`](/algokit-utils-ts/api/subpaths/algod-client/type-aliases/applicationstateoperation/)[]
