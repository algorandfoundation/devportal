...
Defined in: [packages/algod_client/src/apis/api-service.ts:70](https://github.com/larkiny/algokit-utils-ts/blob/main/packages/algod_client/src/apis/api-service.ts#L70)
