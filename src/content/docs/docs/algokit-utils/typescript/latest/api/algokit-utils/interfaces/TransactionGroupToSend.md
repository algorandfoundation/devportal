...
> `optional` **sendParams**: `Omit`\<[`SendTransactionParams`](/algokit-utils-ts/api/algokit-utils/interfaces/sendtransactionparams/), `"fee"` \| `"maxFee"` \| `"skipSending"` \| `"atc"`\>
...
> `optional` **signer**: [`SendingAddress`](/algokit-utils-ts/api/subpaths/transact/type-aliases/sendingaddress/)
...
> **transactions**: ([`Transaction`](/algokit-utils-ts/api/subpaths/transact/classes/transaction/) \| [`TransactionToSign`](/algokit-utils-ts/api/algokit-utils/interfaces/transactiontosign/) \| `Promise`\<[`SendTransactionResult`](/algokit-utils-ts/api/algokit-utils/interfaces/sendtransactionresult/)\>)[]
