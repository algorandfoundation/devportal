...
Defined in: [packages/transact/src/transactions/reference-types-meta.ts:24](https://github.com/larkiny/algokit-utils-ts/blob/main/packages/transact/src/transactions/reference-types-meta.ts#L24)
