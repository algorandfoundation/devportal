...
- [constructor](/docs/algokit-utils/typescript/latest/api/interfaces/types_client_manager.TypedAppFactory/#constructor)
...
| Name     | Type                                                                                                                                  |
| :------- | :------------------------------------------------------------------------------------------------------------------------------------ |
| `params` | `Omit`\<[`AppFactoryParams`](/docs/algokit-utils/typescript/latest/api/interfaces/types_app_factory.AppFactoryParams/), `"appSpec"`\> |
