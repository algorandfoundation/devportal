...
> **decodeAVMValue**(`avmType`, `bytes`): [`ABIValue`](/algokit-utils-ts/api/subpaths/abi/type-aliases/abivalue/)
...
[`AVMType`](/algokit-utils-ts/api/subpaths/abi/type-aliases/avmtype/)
