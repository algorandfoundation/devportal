...
> `optional` **participant**: [`StateProofParticipant`](/algokit-utils-ts/api/subpaths/indexer-client/type-aliases/stateproofparticipant/)
...
> `optional` **sigSlot**: [`StateProofSigSlot`](/algokit-utils-ts/api/subpaths/indexer-client/type-aliases/stateproofsigslot/)
