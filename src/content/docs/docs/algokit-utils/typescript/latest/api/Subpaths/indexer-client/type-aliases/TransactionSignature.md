...
> `optional` **logicsig**: [`TransactionSignatureLogicsig`](/algokit-utils-ts/api/subpaths/indexer-client/type-aliases/transactionsignaturelogicsig/)
...
> `optional` **multisig**: [`TransactionSignatureMultisig`](/algokit-utils-ts/api/subpaths/indexer-client/type-aliases/transactionsignaturemultisig/)
