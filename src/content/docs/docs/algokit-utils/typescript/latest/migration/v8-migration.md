...
Using the context gathered from Step 1, you should have all the information you need to migrate using the [version 7 migration guide](/docs/algokit-utils/typescript/latest/migration/v7-migration/#post-610-migration-guide).
