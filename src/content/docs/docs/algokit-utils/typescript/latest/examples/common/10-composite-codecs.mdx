---
title: "Composite Codecs"
description: "This example demonstrates how to use composite codec types for encoding/decoding arrays, maps, and records in wire format (JSON or MessagePack)."
sidebar:
  order: 10
---
...
This example demonstrates how to use composite codec types for encoding/decoding arrays, maps, and records in wire format (JSON or MessagePack).
 Topics covered:
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/common/10-composite-codecs.ts)

```typescript title="10-composite-codecs.ts"
/**
