---
title: "ABI Struct and Tuple Conversion"
description: "This example demonstrates how to convert between struct values (named) and tuple values (positional):"
sidebar:
  order: 9
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/abi/09-struct-tuple-conversion.ts)

```typescript title="09-struct-tuple-conversion.ts"
/**
