...
description: 'This example demonstrates how to configure suggested transaction parameters:'
sidebar:
  order: 4
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/algorand_client/04-params-config.ts)

```typescript title="04-params-config.ts"
/**
