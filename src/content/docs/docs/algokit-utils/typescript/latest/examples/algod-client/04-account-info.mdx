...
description: "This example demonstrates how to retrieve comprehensive account information using the AlgodClient methods: accountInformation(), accountApplicationInformation(), and accountAssetInformation()."
sidebar:
  order: 4
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/algod_client/04-account-info.ts)

```typescript title="04-account-info.ts"
/**
