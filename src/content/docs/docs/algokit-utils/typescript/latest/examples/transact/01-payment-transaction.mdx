...
description: 'This example demonstrates how to send ALGO between accounts using the transact package. It shows the low-level transaction construction pattern with:'
sidebar:
  order: 1
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/transact/01-payment-transaction.ts)

```typescript title="01-payment-transaction.ts"
/**
