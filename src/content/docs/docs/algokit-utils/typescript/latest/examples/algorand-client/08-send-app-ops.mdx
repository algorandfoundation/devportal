---
title: 'Send Application Operations'
description: 'This example demonstrates how to perform smart contract (application) operations:'
sidebar:
  order: 8
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/algorand_client/08-send-app-ops.ts)

```typescript title="08-send-app-ops.ts"
/**
