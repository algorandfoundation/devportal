...
description: 'This example demonstrates how to query pending transactions in the transaction pool using pendingTransactions() and pendingTransactionsByAddress(). Pending transactions are those that have been submitted but not yet confirmed in a block.'
sidebar:
  order: 7
---
...
This example demonstrates how to query pending transactions in the transaction pool using pendingTransactions() and pendingTransactionsByAddress(). Pending transactions are those that have been submitted but not yet confirmed in a block.
...
```bash
cd examples
npm run example algod_client/07-pending-transactions.ts
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/algod_client/07-pending-transactions.ts)

```typescript title="07-pending-transactions.ts"
/**
...
function displayPendingTransaction(
  txn: PendingTransactionsResponse['topTransactions'][number],
  index: number,
): void {
