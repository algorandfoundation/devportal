...
description: 'This example demonstrates how to deploy and interact with a smart contract on Algorand using the transact package:'
sidebar:
  order: 14
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/transact/14-app-call.ts)

```typescript title="14-app-call.ts"
/**
