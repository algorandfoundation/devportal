---
title: "Multisig"
description: "This example demonstrates how to create and use a 2-of-3 multisig account."
sidebar:
  order: 10
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/transact/10-multisig.ts)

```typescript title="10-multisig.ts"
/**
 * Example: Multisig
 *
 * This example demonstrates how to create and use a 2-of-3 multisig account.
