...
description: 'This example demonstrates how to use checkServerHealth() to verify mock server availability before running tests. The function checks if a server is reachable by performing a health check request.'
sidebar:
  order: 3
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/testing/03-health-check.ts)

```typescript title="03-health-check.ts"
/**
