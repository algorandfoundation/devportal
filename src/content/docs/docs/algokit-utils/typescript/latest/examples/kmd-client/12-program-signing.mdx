---
title: 'Program Signing (Delegated Logic Signatures) with KMD'
description: 'This example demonstrates how to sign programs/contracts using the KMD `signProgram()` method. It shows:'
sidebar:
  order: 12
---
...
This example demonstrates how to sign programs/contracts using the KMD `signProgram()` method. It shows:
...
```bash
cd examples
npm run example kmd_client/12-program-signing.ts
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/kmd_client/12-program-signing.ts)

```typescript title="12-program-signing.ts"
/**
