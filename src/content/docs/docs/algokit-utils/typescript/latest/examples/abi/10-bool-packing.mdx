---
title: "ABI Bool Array Packing"
description: "This example demonstrates how bool arrays are packed efficiently in ARC-4:"
sidebar:
  order: 10
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/abi/10-bool-packing.ts)

```typescript title="10-bool-packing.ts"
/**
