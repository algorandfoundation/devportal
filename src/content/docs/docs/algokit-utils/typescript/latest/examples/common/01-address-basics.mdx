...
description: 'This example demonstrates basic address operations using the Address class:'
sidebar:
  order: 1
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/common/01-address-basics.ts)

```typescript title="01-address-basics.ts"
/**
