...
description: 'This example demonstrates the array utility functions for comparing and concatenating byte arrays:'
sidebar:
  order: 3
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/common/03-array-utilities.ts)

```typescript title="03-array-utilities.ts"
/**
