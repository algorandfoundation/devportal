...
description: 'This example demonstrates how to use seedFromMnemonic() to convert a 25-word Algorand mnemonic back to its original 32-byte seed. This is the reverse operation of mnemonicFromSeed().'
sidebar:
  order: 2
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/algo25/02-seed-from-mnemonic.ts)

```typescript title="02-seed-from-mnemonic.ts"
/**
