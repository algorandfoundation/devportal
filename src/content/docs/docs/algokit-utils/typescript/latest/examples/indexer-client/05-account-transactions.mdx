...
description: "This example demonstrates how to query an account's transaction history using the IndexerClient lookupAccountTransactions() method."
sidebar:
  order: 5
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/indexer_client/05-account-transactions.ts)

```typescript title="05-account-transactions.ts"
/**
