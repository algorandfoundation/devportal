---
title: 'ABI Primitive Types'
description: 'This example demonstrates how to encode and decode primitive ABI types:'
sidebar:
  order: 2
---
...
```bash
cd examples
npm run example abi/02-primitive-types.ts
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/abi/02-primitive-types.ts)

```typescript title="02-primitive-types.ts"
/**
...
function main() {
  ...
  const uint256Value =
    115792089237316195423570985008687907853269984665640564039457584007913129639935n; // 2^256 - 1 (max uint256)
