---
title: 'Multisig Account Setup'
description: 'This example demonstrates how to create multisig accounts using the KMD `importMultisig()` method.'
sidebar:
  order: 8
---
...
This example demonstrates how to create multisig accounts using the KMD `importMultisig()` method.
Key concepts:
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/kmd_client/08-multisig-setup.ts)

```typescript title="08-multisig-setup.ts"
/**
