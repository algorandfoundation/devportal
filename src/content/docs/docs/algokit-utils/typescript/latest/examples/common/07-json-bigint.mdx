---
title: "JSON BigInt"
description: "This example demonstrates parsing and stringifying JSON with BigInt support for handling large numbers safely without precision loss."
sidebar:
  order: 7
---
...
This example demonstrates parsing and stringifying JSON with BigInt support for handling large numbers safely without precision loss.
 Topics covered:
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/common/07-json-bigint.ts)

```typescript title="07-json-bigint.ts"
/**
 * Example: JSON BigInt
 *
