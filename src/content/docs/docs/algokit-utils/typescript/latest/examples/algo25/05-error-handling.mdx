...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/algo25/05-error-handling.ts)

```typescript title="05-error-handling.ts"
/**
