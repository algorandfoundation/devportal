...
description: "This example demonstrates how to lookup all holders of an asset using the IndexerClient lookupAssetBalances() method."
sidebar:
  order: 9
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/indexer_client/09-asset-balances.ts)

```typescript title="09-asset-balances.ts"
/**
