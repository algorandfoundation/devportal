---
title: 'ABI Tuple Type'
description: 'This example demonstrates how to encode and decode tuples using ABITupleType:'
sidebar:
  order: 7
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/abi/07-tuple-type.ts)

```typescript title="07-tuple-type.ts"
/**
