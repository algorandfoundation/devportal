---
title: 'ABI Static Array Type'
description: 'This example demonstrates how to encode and decode fixed-length arrays using ABIArrayStaticType:'
sidebar:
  order: 5
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/abi/05-static-array.ts)

```typescript title="05-static-array.ts"
/**
...
function main() {
  ...
  printInfo(
    `  Matches originals: ${extractedAddr1 === addressValues[0] && extractedAddr2 === addressValues[1]}`,
  );
