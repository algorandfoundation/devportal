---
title: 'AlgoAmount Utility'
description: 'This example demonstrates how to use the AlgoAmount utility class to work with ALGO and microALGO amounts safely, avoiding floating point precision issues.'
sidebar:
  order: 2
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/algorand_client/02-algo-amount.ts)

```typescript title="02-algo-amount.ts"
/**
