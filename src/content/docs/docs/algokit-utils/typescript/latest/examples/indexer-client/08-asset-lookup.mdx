---
title: "Asset Lookup"
description: "This example demonstrates how to lookup and search for assets using the IndexerClient lookupAssetById() and searchForAssets() methods."
sidebar:
  order: 8
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/indexer_client/08-asset-lookup.ts)

```typescript title="08-asset-lookup.ts"
/**
