---
title: 'ABI Complex Nested Types'
description: 'This example demonstrates how to work with deeply nested ABI types combining arrays, tuples, and structs:'
sidebar:
  order: 14
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/abi/14-complex-nested.ts)

```typescript title="14-complex-nested.ts"
/**
