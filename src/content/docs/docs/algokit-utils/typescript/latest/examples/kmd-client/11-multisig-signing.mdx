---
title: 'Multisig Transaction Signing with KMD'
description: 'This example demonstrates how to sign multisig transactions using the KMD `signMultisigTransaction()` method. It shows:'
sidebar:
  order: 11
---
...
This example demonstrates how to sign multisig transactions using the KMD `signMultisigTransaction()` method. It shows:
...
```bash
cd examples
npm run example kmd_client/11-multisig-signing.ts
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/kmd_client/11-multisig-signing.ts)

```typescript title="11-multisig-signing.ts"
/**
