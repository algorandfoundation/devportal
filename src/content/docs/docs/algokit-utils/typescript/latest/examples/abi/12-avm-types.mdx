---
title: 'AVM Type Encoding'
description: 'This example demonstrates how to work with AVM-specific types:'
sidebar:
  order: 12
---

[← Back to ABI Encoding](/docs/algokit-utils/typescript/latest/examples/abi/)
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/abi/12-avm-types.ts)

```typescript title="12-avm-types.ts"
/**
...
function main() {
  ...
  printInfo(
    `  Result type: ${avmBytesDecoded instanceof Uint8Array ? 'Uint8Array' : typeof avmBytesDecoded}`,
  );
  ...
  printInfo(
    `    First 2 bytes: ${formatHex(abiStringEncoded.slice(0, 2))} = ${(abiStringEncoded[0] << 8) | abiStringEncoded[1]} (length)`,
  );
  printInfo('');
  ...
  printInfo(
    `  Match: ${Buffer.from(avmUint64Encoded).toString('hex') === Buffer.from(abiUint64Encoded).toString('hex')}`,
  );
  ...
  const matchBytes =
    originalBytes.length === decBytes.length && originalBytes.every((b, i) => b === decBytes[i]);
...
- [ABI Type Parsing](/docs/algokit-utils/typescript/latest/examples/abi/01-type-parsing/)
- [ABI Primitive Types](/docs/algokit-utils/typescript/latest/examples/abi/02-primitive-types/)
- [ABI Address Type](/docs/algokit-utils/typescript/latest/examples/abi/03-address-type/)
- [ABI String Type](/docs/algokit-utils/typescript/latest/examples/abi/04-string-type/)
- [ABI Static Array Type](/docs/algokit-utils/typescript/latest/examples/abi/05-static-array/)
- [ABI Dynamic Array Type](/docs/algokit-utils/typescript/latest/examples/abi/06-dynamic-array/)
- [ABI Tuple Type](/docs/algokit-utils/typescript/latest/examples/abi/07-tuple-type/)
- [ABI Struct Type](/docs/algokit-utils/typescript/latest/examples/abi/08-struct-type/)
- [ABI Struct and Tuple Conversion](/docs/algokit-utils/typescript/latest/examples/abi/09-struct-tuple-conversion/)
- [ABI Bool Array Packing](/docs/algokit-utils/typescript/latest/examples/abi/10-bool-packing/)
- [ABI Method](/docs/algokit-utils/typescript/latest/examples/abi/11-abi-method/)
- **AVM Type Encoding**
- [Type Guards](/docs/algokit-utils/typescript/latest/examples/abi/13-type-guards/)
- [ABI Complex Nested Types](/docs/algokit-utils/typescript/latest/examples/abi/14-complex-nested/)
- [ARC-56 Storage Helpers](/docs/algokit-utils/typescript/latest/examples/abi/15-arc56-storage/)
