...
description: "This example demonstrates how to lookup a single transaction by ID using the IndexerClient lookupTransactionById() method."
sidebar:
  order: 6
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/indexer_client/06-transaction-lookup.ts)

```typescript title="06-transaction-lookup.ts"
/**
