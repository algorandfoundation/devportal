---
title: "Error Transformers"
description: "This example demonstrates how to register custom error transformers to enhance error messages and debugging information for failed transactions:"
sidebar:
  order: 15
---
...
```bash
cd examples
npm run example algorand_client/15-error-transformers.ts
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/algorand_client/15-error-transformers.ts)

```typescript title="15-error-transformers.ts"
/**
