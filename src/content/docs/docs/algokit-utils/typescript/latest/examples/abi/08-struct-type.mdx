---
title: 'ABI Struct Type'
description: 'This example demonstrates how to encode and decode named structs using ABIStructType:'
sidebar:
  order: 8
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/abi/08-struct-type.ts)

```typescript title="08-struct-type.ts"
/**
