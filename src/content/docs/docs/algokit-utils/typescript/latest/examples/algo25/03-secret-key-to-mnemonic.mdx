...
description: 'This example demonstrates how to use secretKeyToMnemonic() to convert a 64-byte Algorand secret key to a 25-word mnemonic.'
sidebar:
  order: 3
---
...
```bash
cd examples
npm run example algo25/03-secret-key-to-mnemonic.ts
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/algo25/03-secret-key-to-mnemonic.ts)

```typescript title="03-secret-key-to-mnemonic.ts"
/**
