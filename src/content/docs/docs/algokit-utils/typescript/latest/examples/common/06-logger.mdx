---
title: 'Logger Type'
description: 'This example demonstrates the Logger interface for consistent logging across the AlgoKit Utils SDK.'
sidebar:
  order: 6
---
...
This example demonstrates the Logger interface for consistent logging across the AlgoKit Utils SDK.
Topics covered:
...
```bash
cd examples
npm run example common/06-logger.ts
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/common/06-logger.ts)

```typescript title="06-logger.ts"
/**
 * Example: Logger Type
 *
