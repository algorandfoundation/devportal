...
description: "This example demonstrates how to lookup and search for applications using the IndexerClient lookupApplicationById() and searchForApplications() methods."
sidebar:
  order: 11
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/indexer_client/11-application-lookup.ts)

```typescript title="11-application-lookup.ts"
/**
