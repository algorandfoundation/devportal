---
title: "DevMode Timestamp Offset"
description: "This example demonstrates how to manage block timestamp offset in DevMode using:"
sidebar:
  order: 18
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/algod_client/18-devmode-timestamp.ts)

```typescript title="18-devmode-timestamp.ts"
/**
