---
title: "Wallet Creation and Listing"
description: "This example demonstrates how to create, list, rename, and get info about wallets using the KMD (Key Management Daemon) client."
sidebar:
  order: 2
---
...
```bash
cd examples
npm run example kmd_client/02-wallet-management.ts
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/kmd_client/02-wallet-management.ts)

```typescript title="02-wallet-management.ts"
/**
