...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/common/02-address-encoding.ts)

```typescript title="02-address-encoding.ts"
/**
