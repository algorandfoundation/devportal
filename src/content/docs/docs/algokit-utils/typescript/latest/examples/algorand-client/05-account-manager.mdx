...
description: "This example demonstrates how to use the account manager to create, import, and manage accounts including:"
sidebar:
  order: 5
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/algorand_client/05-account-manager.ts)

```typescript title="05-account-manager.ts"
/**
