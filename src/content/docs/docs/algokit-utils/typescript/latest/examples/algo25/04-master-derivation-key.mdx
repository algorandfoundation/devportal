---
title: 'Master Derivation Key Functions'
description: 'This example demonstrates the master derivation key (MDK) alias functions and shows their equivalence to the core seed/mnemonic functions.'
sidebar:
  order: 4
---
...
```bash
cd examples
npm run example algo25/04-master-derivation-key.ts
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/algo25/04-master-derivation-key.ts)

```typescript title="04-master-derivation-key.ts"
/**
...
- [Mnemonic from Seed](/docs/algokit-utils/typescript/latest/examples/algo25/01-mnemonic-from-seed/)
