---
title: "ABI Dynamic Array Type"
description: "This example demonstrates how to encode and decode variable-length arrays using ABIArrayDynamicType:"
sidebar:
  order: 6
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/abi/06-dynamic-array.ts)

```typescript title="06-dynamic-array.ts"
/**
