---
title: 'ABI String Type'
description: 'This example demonstrates how to encode and decode dynamic strings using ABIStringType:'
sidebar:
  order: 4
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/abi/04-string-type.ts)

```typescript title="04-string-type.ts"
/**
