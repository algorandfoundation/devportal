...
description: 'This example demonstrates how to query application boxes using the AlgodClient methods: applicationBoxes() and applicationBoxByName()'
sidebar:
  order: 11
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/algod_client/11-application-boxes.ts)

```typescript title="11-application-boxes.ts"
/**
