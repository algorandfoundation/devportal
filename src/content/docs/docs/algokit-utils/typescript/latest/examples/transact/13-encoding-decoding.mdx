...
description: "This example demonstrates how to serialize and deserialize transactions using the transact package:"
sidebar:
  order: 13
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/transact/13-encoding-decoding.ts)

```typescript title="13-encoding-decoding.ts"
/**
