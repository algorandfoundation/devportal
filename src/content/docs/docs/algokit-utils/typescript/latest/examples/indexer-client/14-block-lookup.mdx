---
title: 'Block Lookup'
description: 'This example demonstrates how to lookup block information using the IndexerClient lookupBlock() method.'
sidebar:
  order: 14
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/indexer_client/14-block-lookup.ts)

```typescript title="14-block-lookup.ts"
/**
