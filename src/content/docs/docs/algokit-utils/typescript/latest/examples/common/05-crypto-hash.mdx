...
description: 'This example demonstrates the hash() function for computing Algorand-compatible SHA-512/256 hashes. This hash algorithm is used throughout Algorand for:'
sidebar:
  order: 5
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/common/05-crypto-hash.ts)

```typescript title="05-crypto-hash.ts"
/**
