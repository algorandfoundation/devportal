...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/algod_client/12-teal-compile.ts)

```typescript title="12-teal-compile.ts"
/**
