---
title: 'Pagination'
description: 'This example demonstrates how to properly handle pagination across multiple indexer endpoints using limit and next parameters. It includes a generic pagination helper function and shows iteration through all pages of results.'
sidebar:
  order: 16
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/indexer_client/16-pagination.ts)

```typescript title="16-pagination.ts"
/**
 * Example: Pagination
 *
