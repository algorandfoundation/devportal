---
title: "Asset Manager"
description: "This example demonstrates the AssetManager functionality for querying asset information and performing bulk opt-in/opt-out operations:"
sidebar:
  order: 11
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/algorand_client/11-asset-manager.ts)

```typescript title="11-asset-manager.ts"
/**
