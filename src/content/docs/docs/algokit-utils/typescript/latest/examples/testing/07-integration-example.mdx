---
title: 'Integration Example - Complete Test Setup'
description: 'This example demonstrates how all testing package components work together for a real test scenario. It shows:'
sidebar:
  order: 7
---
...
```bash
cd examples
npm run example testing/07-integration-example.ts
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/testing/07-integration-example.ts)

```typescript title="07-integration-example.ts"
/**
