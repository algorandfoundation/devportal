---
title: 'Payment with Close'
description: 'This example demonstrates how to close an account by transferring all remaining ALGO to another account using the closeRemainderTo field in PaymentTransactionFields.'
sidebar:
  order: 2
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/examples/transact/02-payment-close.ts)

```typescript title="02-payment-close.ts"
/**
