...
To understand how to create, simulate and send transactions consult the [`AlgorandClient`](/docs/algokit-utils/python/latest/concepts/core/algorand-client/) and [`TransactionComposer`](/docs/algokit-utils/python/latest/concepts/advanced/transaction-composer/) documentation.
