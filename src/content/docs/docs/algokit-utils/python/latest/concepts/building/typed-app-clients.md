...
Typed application clients are the recommended way of interacting with smart contracts. If you don't have/want a typed client, but have an ARC-56/ARC-32 app spec then you can use the [non-typed application clients](/docs/algokit-utils/python/latest/concepts/building/app-client/) and if you want to call a smart contract you don't have an app spec file for you can use the underlying [app management](/docs/algokit-utils/python/latest/concepts/building/app/) and [app deployment](/docs/algokit-utils/python/latest/concepts/building/app-deploy/) functionality to manually construct transactions.
...
To get an instance of a typed client you can use an [`AlgorandClient`](/docs/algokit-utils/python/latest/concepts/core/algorand-client/) instance or a typed app [`Factory`](#creating-a-typed-factory-instance) instance.
...
To understand the difference between resolving by ID vs by creator and name see the underlying [app client documentation](/docs/algokit-utils/python/latest/concepts/building/app-client/#appclient).
