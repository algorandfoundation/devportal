...
#### compile_teal(teal_code: str) → [algokit_utils.models.application.CompiledTeal](/docs/algokit-utils/python/latest/api/models/application/#algokit_utils.models.application.CompiledTeal)
...
#### get_compilation_result(teal_code: str) → [algokit_utils.models.application.CompiledTeal](/docs/algokit-utils/python/latest/api/models/application/#algokit_utils.models.application.CompiledTeal) | None
...
#### get_by_id(app_id: int) → [algokit_utils.models.application.AppInformation](/docs/algokit-utils/python/latest/api/models/application/#algokit_utils.models.application.AppInformation)
...
#### get_global_state(app_id: int) → dict[str, [algokit_utils.models.application.AppState](/docs/algokit-utils/python/latest/api/models/application/#algokit_utils.models.application.AppState)]
...
#### get_local_state(app_id: int, address: str) → dict[str, [algokit_utils.models.application.AppState](/docs/algokit-utils/python/latest/api/models/application/#algokit_utils.models.application.AppState)]
...
#### get_box_names(app_id: int) → list[[algokit_utils.models.state.BoxName](/docs/algokit-utils/python/latest/api/models/state/#algokit_utils.models.state.BoxName)]
