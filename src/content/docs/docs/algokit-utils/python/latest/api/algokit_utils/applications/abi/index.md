...
### algokit_utils.applications.abi.get_arc56_value(abi_return: [ABIReturn](#algokit_utils.applications.abi.ABIReturn), method: Method, structs: dict[str, object] | None = None) → Arc56ReturnValueType

Deprecated: use ABIReturn.value instead.

### algokit_utils.applications.abi.get_abi_encoded_value(value: object, abi_type: ABIType | AVMType) → bytes
...
### algokit_utils.applications.abi.get_abi_decoded_value(value: bytes | int | str, decode_type: AVMType | ABIType | ReferenceType) → ABIValue
