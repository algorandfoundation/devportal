...
- The semantics to resolve the application is now available via [simpler entrypoints within `algorand.client`](/docs/algokit-utils/python/latest/guides/concepts/building/app-client/#appclient)
