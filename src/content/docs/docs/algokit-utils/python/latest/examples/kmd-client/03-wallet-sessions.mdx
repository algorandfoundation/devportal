...
```bash
cd examples
uv run python kmd_client/03_wallet_sessions.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/kmd_client/03_wallet_sessions.py)

```python title="03_wallet_sessions.py"
