...
```bash
cd examples
uv run python transact/06_asset_clawback.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/transact/06_asset_clawback.py)

```python title="06_asset_clawback.py"
