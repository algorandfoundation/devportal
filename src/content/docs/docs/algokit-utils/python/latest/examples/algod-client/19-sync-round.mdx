...
- Applications that don't need ancient historical data
  Key concepts:
- sync*round() returns GetSyncRoundResponse with round* attribute
...
```bash
cd examples
uv run python algod_client/19_sync_round.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/algod_client/19_sync_round.py)

```python title="19_sync_round.py"
