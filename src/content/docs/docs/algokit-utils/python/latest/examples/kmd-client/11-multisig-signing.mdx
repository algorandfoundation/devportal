...
description: 'This example demonstrates how to sign multisig transactions using the KMD sign_multisig_transaction() method. It shows:'
sidebar:
  order: 11
---
...
```bash
cd examples
uv run python kmd_client/11_multisig_signing.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/kmd_client/11_multisig_signing.py)

```python title="11_multisig_signing.py"
