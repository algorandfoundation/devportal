...
```bash
cd examples
uv run python transact/04_asset_transfer.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/transact/04_asset_transfer.py)
