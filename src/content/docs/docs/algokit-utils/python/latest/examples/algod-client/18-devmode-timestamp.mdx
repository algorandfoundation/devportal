...
```bash
cd examples
uv run python algod_client/18_devmode_timestamp.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/algod_client/18_devmode_timestamp.py)

```python title="18_devmode_timestamp.py"
