...
description: 'This example demonstrates how to lookup transactions for a specific asset using the IndexerClient lookup_asset_transactions() method.'
sidebar:
  order: 10
---
...
This example demonstrates how to lookup transactions for a specific asset using the IndexerClient lookup_asset_transactions() method.
Prerequisites:
...
```bash
cd examples
uv run python indexer_client/10_asset_transactions.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/indexer_client/10_asset_transactions.py)

```python title="10_asset_transactions.py"
