...
description: "This example demonstrates how to encode and decode dynamic strings using StringType:"
sidebar:
  order: 4
---
...
```bash
cd examples
uv run python abi/04_string_type.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/abi/04_string_type.py)

```python title="04_string_type.py"
