...
description: "This example displays all the protocol constants available in the algokit_common package. These constants define limits, sizes, and separators used throughout Algorand."
sidebar:
  order: 4
---
...
```bash
cd examples
uv run python common/04_constants.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/common/04_constants.py)

```python title="04_constants.py"
