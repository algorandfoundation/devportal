...
```bash
cd examples
uv run python abi/02_primitive_types.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/abi/02_primitive_types.py)

```python title="02_primitive_types.py"
