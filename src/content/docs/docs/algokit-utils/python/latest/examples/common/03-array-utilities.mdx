...
description: 'This example demonstrates array utility operations for comparing and concatenating byte arrays in Python:'
sidebar:
  order: 3
---
...
```bash
cd examples
uv run python common/03_array_utilities.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/common/03_array_utilities.py)

```python title="03_array_utilities.py"
