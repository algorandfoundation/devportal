...
description: 'This example demonstrates how to sign programs/contracts using the KMD sign_program() method. It shows:'
sidebar:
  order: 12
---
...
```bash
cd examples
uv run python kmd_client/12_program_signing.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/kmd_client/12_program_signing.py)

```python title="12_program_signing.py"
