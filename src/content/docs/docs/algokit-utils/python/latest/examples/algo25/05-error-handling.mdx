---
title: 'Error Handling for Mnemonic Functions'
description: 'This example demonstrates how to properly handle errors when working with mnemonic functions, including invalid words, bad checksums, and wrong seed lengths.'
sidebar:
  order: 5
---
...
```bash
cd examples
uv run python algo25/05_error_handling.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/algo25/05_error_handling.py)

```python title="05_error_handling.py"
