...
```bash
cd examples
uv run python algod_client/13_simulation.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/algod_client/13_simulation.py)

```python title="13_simulation.py"
