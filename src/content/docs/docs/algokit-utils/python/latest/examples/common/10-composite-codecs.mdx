---
title: "Composite Serde (Serialization/Deserialization)"
description: "This example demonstrates how to serialize/deserialize composite data structures like arrays, maps, and records in Python using the serde utilities."
sidebar:
  order: 10
---

[← Back to Common Utilities](/docs/algokit-utils/python/latest/examples/common/)
...
```bash
cd examples
uv run python common/10_composite_codecs.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/common/10_composite_codecs.py)

```python title="10_composite_codecs.py"
...
- [Address Basics](/docs/algokit-utils/python/latest/examples/common/01-address-basics/)
- [Address Encoding](/docs/algokit-utils/python/latest/examples/common/02-address-encoding/)
- [Array Utilities](/docs/algokit-utils/python/latest/examples/common/03-array-utilities/)
- [Constants Reference](/docs/algokit-utils/python/latest/examples/common/04-constants/)
- [Crypto Hash (SHA-512/256)](/docs/algokit-utils/python/latest/examples/common/05-crypto-hash/)
- [Example](/docs/algokit-utils/python/latest/examples/common/06-logger/)
- [JSON BigInt Support](/docs/algokit-utils/python/latest/examples/common/07-json-bigint/)
- [MessagePack Encoding](/docs/algokit-utils/python/latest/examples/common/08-msgpack/)
- [Primitive Serde (Serialization/Deserialization)](/docs/algokit-utils/python/latest/examples/common/09-primitive-codecs/)
- **Composite Serde (Serialization/Deserialization)**
- [Model Serde (Object Model Serialization)](/docs/algokit-utils/python/latest/examples/common/11-model-codecs/)
- [Sourcemap for TEAL Debugging](/docs/algokit-utils/python/latest/examples/common/12-sourcemap/)
