...
```bash
cd examples
uv run python transact/12_fee_calculation.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/transact/12_fee_calculation.py)

```python title="12_fee_calculation.py"
