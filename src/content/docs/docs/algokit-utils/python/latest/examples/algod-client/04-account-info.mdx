...
description: "This example demonstrates how to retrieve comprehensive account information using the AlgodClient methods: account_information(), account_application_information(), and account_asset_information()."
sidebar:
  order: 4
---
...
```bash
cd examples
uv run python algod_client/04_account_info.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/algod_client/04_account_info.py)

```python title="04_account_info.py"
