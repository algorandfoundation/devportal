...
description: 'This example demonstrates how to import and export keys using the KMD import_key() and export_key() methods.'
sidebar:
  order: 5
---
...
```bash
cd examples
uv run python kmd_client/05_key_import_export.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/kmd_client/05_key_import_export.py)

```python title="05_key_import_export.py"
