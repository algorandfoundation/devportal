...
[← Back to ABI Encoding](/docs/algokit-utils/python/latest/examples/abi/)
...
```bash
cd examples
uv run python abi/15_arc56_storage.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/abi/15_arc56_storage.py)

```python title="15_arc56_storage.py"
...
- [ABI Type Parsing](/docs/algokit-utils/python/latest/examples/abi/01-type-parsing/)
- [ABI Primitive Types](/docs/algokit-utils/python/latest/examples/abi/02-primitive-types/)
- [ABI Address Type](/docs/algokit-utils/python/latest/examples/abi/03-address-type/)
- [ABI String Type](/docs/algokit-utils/python/latest/examples/abi/04-string-type/)
- [ABI Static Array Type](/docs/algokit-utils/python/latest/examples/abi/05-static-array/)
- [ABI Dynamic Array Type](/docs/algokit-utils/python/latest/examples/abi/06-dynamic-array/)
- [ABI Tuple Type](/docs/algokit-utils/python/latest/examples/abi/07-tuple-type/)
- [ABI Struct Type](/docs/algokit-utils/python/latest/examples/abi/08-struct-type/)
- [ABI Struct and Tuple Conversion](/docs/algokit-utils/python/latest/examples/abi/09-struct-tuple-conversion/)
- [ABI Bool Array Packing](/docs/algokit-utils/python/latest/examples/abi/10-bool-packing/)
- [ABI Method](/docs/algokit-utils/python/latest/examples/abi/11-abi-method/)
- [AVM Type Encoding](/docs/algokit-utils/python/latest/examples/abi/12-avm-types/)
- [Type Guards](/docs/algokit-utils/python/latest/examples/abi/13-type-guards/)
- [ABI Complex Nested Types](/docs/algokit-utils/python/latest/examples/abi/14-complex-nested/)
