...
description: 'This example demonstrates how to encode and decode Algorand addresses using AddressType:'
sidebar:
  order: 3
---
...
```bash
cd examples
uv run python abi/03_address_type.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/abi/03_address_type.py)

```python title="03_address_type.py"
