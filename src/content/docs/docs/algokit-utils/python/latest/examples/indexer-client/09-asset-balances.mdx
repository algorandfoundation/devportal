...
description: 'This example demonstrates how to lookup all holders of an asset using the IndexerClient lookup_asset_balances() method.'
sidebar:
  order: 9
---
...
This example demonstrates how to lookup all holders of an asset using the IndexerClient lookup_asset_balances() method.
Prerequisites:
...
```bash
cd examples
uv run python indexer_client/09_asset_balances.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/indexer_client/09_asset_balances.py)

```python title="09_asset_balances.py"
