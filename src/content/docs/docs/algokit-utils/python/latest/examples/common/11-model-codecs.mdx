---
title: "Model Serde (Object Model Serialization)"
description: "This example demonstrates how to use dataclass-based serialization for complex object structures with field metadata in Python."
sidebar:
  order: 11
---
...
```bash
cd examples
uv run python common/11_model_codecs.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/common/11_model_codecs.py)

```python title="11_model_codecs.py"
