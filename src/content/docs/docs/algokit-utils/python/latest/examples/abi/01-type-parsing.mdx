...
description: "This example demonstrates how to parse ABI type strings into type objects using ABIType.from_string(). It shows parsing of:"
sidebar:
  order: 1
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/abi/01_type_parsing.py)

```python title="01_type_parsing.py"
