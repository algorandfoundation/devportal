...
```bash
cd examples
uv run python algod_client/15_transaction_proof.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/algod_client/15_transaction_proof.py)

```python title="15_transaction_proof.py"
