...
description: 'This example demonstrates how to query account application relationships using the IndexerClient lookup_account_created_applications() and lookup_account_app_local_states() methods.'
sidebar:
  order: 4
---
...
This example demonstrates how to query account application relationships using the IndexerClient lookup_account_created_applications() and lookup_account_app_local_states() methods.
Prerequisites:
...
```bash
cd examples
uv run python indexer_client/04_account_applications.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/indexer_client/04_account_applications.py)

```python title="04_account_applications.py"
...
- [Indexer Health Check](/docs/algokit-utils/python/latest/examples/indexer-client/01-health-check/)
