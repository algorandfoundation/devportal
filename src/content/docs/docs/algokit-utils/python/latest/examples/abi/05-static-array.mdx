...
description: "This example demonstrates how to encode and decode fixed-length arrays using StaticArrayType:"
sidebar:
  order: 5
---
...
```bash
cd examples
uv run python abi/05_static_array.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/abi/05_static_array.py)

```python title="05_static_array.py"
