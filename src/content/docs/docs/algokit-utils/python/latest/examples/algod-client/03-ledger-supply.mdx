...
```bash
cd examples
uv run python algod_client/03_ledger_supply.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/algod_client/03_ledger_supply.py)

```python title="03_ledger_supply.py"
