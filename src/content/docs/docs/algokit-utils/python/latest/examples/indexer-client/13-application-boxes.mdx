...
description: 'This example demonstrates how to query application boxes using the IndexerClient search_for_application_boxes() and lookup_application_box_by_id_and_name() methods.'
sidebar:
  order: 13
---
...
This example demonstrates how to query application boxes using the IndexerClient search_for_application_boxes() and lookup_application_box_by_id_and_name() methods.
Prerequisites:
...
```bash
cd examples
uv run python indexer_client/13_application_boxes.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/indexer_client/13_application_boxes.py)

```python title="13_application_boxes.py"
