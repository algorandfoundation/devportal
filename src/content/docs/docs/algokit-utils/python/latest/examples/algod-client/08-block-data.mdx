---
title: 'Block Data'
description: 'This example demonstrates how to retrieve block information using the AlgodClient methods: block(), block_hash(), and block_tx_ids().'
sidebar:
  order: 8
---
...
```bash
cd examples
uv run python algod_client/08_block_data.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/algod_client/08_block_data.py)

```python title="08_block_data.py"
