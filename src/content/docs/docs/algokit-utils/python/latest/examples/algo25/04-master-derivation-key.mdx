...
```bash
cd examples
uv run python algo25/04_master_derivation_key.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/algo25/04_master_derivation_key.py)

```python title="04_master_derivation_key.py"
