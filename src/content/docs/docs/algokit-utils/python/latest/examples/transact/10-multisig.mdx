...
```bash
cd examples
uv run python transact/10_multisig.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/transact/10_multisig.py)

```python title="10_multisig.py"
