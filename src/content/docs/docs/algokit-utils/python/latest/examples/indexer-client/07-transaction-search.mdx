...
description: "This example demonstrates how to search for transactions with various filters using the IndexerClient search_for_transactions() method."
sidebar:
  order: 7
---
...
This example demonstrates how to search for transactions with various filters using the IndexerClient search_for_transactions() method.
 Prerequisites:
...
```bash
cd examples
uv run python indexer_client/07_transaction_search.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/indexer_client/07_transaction_search.py)

```python title="07_transaction_search.py"
