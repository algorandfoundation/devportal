...
description: "This example demonstrates basic address operations using the algokit_common module:"
sidebar:
  order: 1
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/common/01_address_basics.py)

```python title="01_address_basics.py"
