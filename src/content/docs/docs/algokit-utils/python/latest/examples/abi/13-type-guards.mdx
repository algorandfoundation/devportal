---
title: 'Type Guards'
description: 'This example demonstrates how to check argument and type categories in the ABI system:'
sidebar:
  order: 13
---
...
```bash
cd examples
uv run python abi/13_type_guards.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/abi/13_type_guards.py)

```python title="13_type_guards.py"
