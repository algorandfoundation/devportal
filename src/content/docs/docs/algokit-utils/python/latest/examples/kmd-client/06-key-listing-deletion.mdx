...
description: 'This example demonstrates how to list all keys in a wallet and delete specific keys using the KMD list_keys() and delete_key() methods.'
sidebar:
  order: 6
---
...
```bash
cd examples
uv run python kmd_client/06_key_listing_deletion.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/kmd_client/06_key_listing_deletion.py)

```python title="06_key_listing_deletion.py"
