---
title: "Asset Lookup"
description: "This example demonstrates how to lookup and search for assets using the IndexerClient lookup_asset_by_id() and search_for_assets() methods."
sidebar:
  order: 8
---
...
This example demonstrates how to lookup and search for assets using the IndexerClient lookup_asset_by_id() and search_for_assets() methods.
 Prerequisites:
...
```bash
cd examples
uv run python indexer_client/08_asset_lookup.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/indexer_client/08_asset_lookup.py)

```python title="08_asset_lookup.py"
