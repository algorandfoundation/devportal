...
```bash
cd examples
uv run python transact/09_single_sig.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/transact/09_single_sig.py)

```python title="09_single_sig.py"
