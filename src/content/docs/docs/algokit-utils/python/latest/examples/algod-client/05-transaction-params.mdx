...
description: 'This example demonstrates how to get suggested transaction parameters using suggested_params(). These parameters are essential for constructing valid transactions on the Algorand network.'
sidebar:
  order: 5
---
...
```bash
cd examples
uv run python algod_client/05_transaction_params.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/algod_client/05_transaction_params.py)

```python title="05_transaction_params.py"
