...
description: "This example demonstrates how to lookup account information using the IndexerClient lookup_account_by_id() and search_for_accounts() methods."
sidebar:
  order: 2
---
...
This example demonstrates how to lookup account information using the IndexerClient lookup_account_by_id() and search_for_accounts() methods.
 Prerequisites:
...
```bash
cd examples
uv run python indexer_client/02_account_lookup.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/indexer_client/02_account_lookup.py)

```python title="02_account_lookup.py"
