...
```bash
cd examples
uv run python abi/11_abi_method.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/abi/11_abi_method.py)

```python title="11_abi_method.py"
