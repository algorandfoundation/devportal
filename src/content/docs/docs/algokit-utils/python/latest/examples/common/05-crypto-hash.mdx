---
title: "Crypto Hash (SHA-512/256)"
description: "This example demonstrates the sha512_256() function for computing Algorand-compatible SHA-512/256 hashes. This hash algorithm is used throughout Algorand for:"
sidebar:
  order: 5
---
...
```bash
cd examples
uv run python common/05_crypto_hash.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/common/05_crypto_hash.py)

```python title="05_crypto_hash.py"
...
- [Composite Serde (Serialization/Deserialization)](/docs/algokit-utils/python/latest/examples/common/10-composite-codecs/)
