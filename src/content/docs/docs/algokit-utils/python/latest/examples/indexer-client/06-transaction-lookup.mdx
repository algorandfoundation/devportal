...
description: "This example demonstrates how to lookup a single transaction by ID using the IndexerClient lookup_transaction_by_id() method."
sidebar:
  order: 6
---
...
This example demonstrates how to lookup a single transaction by ID using the IndexerClient lookup_transaction_by_id() method.
 Prerequisites:
...
```bash
cd examples
uv run python indexer_client/06_transaction_lookup.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/indexer_client/06_transaction_lookup.py)

```python title="06_transaction_lookup.py"
