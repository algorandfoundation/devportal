...
```bash
cd examples
uv run python transact/05_asset_freeze.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/transact/05_asset_freeze.py)

```python title="05_asset_freeze.py"
