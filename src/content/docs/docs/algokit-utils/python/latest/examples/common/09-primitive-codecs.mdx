---
title: 'Primitive Serde (Serialization/Deserialization)'
description: 'This example demonstrates how to use primitive serialization patterns in Python for encoding/decoding basic values in wire format.'
sidebar:
  order: 9
---
...
```bash
cd examples
uv run python common/09_primitive_codecs.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/common/09_primitive_codecs.py)

```python title="09_primitive_codecs.py"
