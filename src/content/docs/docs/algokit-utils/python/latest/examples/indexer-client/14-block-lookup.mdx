---
title: 'Block Lookup'
description: 'This example demonstrates how to lookup block information using the IndexerClient lookup_block() method.'
sidebar:
  order: 14
---
...
This example demonstrates how to lookup block information using the IndexerClient lookup_block() method.
Prerequisites:
...
```bash
cd examples
uv run python indexer_client/14_block_lookup.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/indexer_client/14_block_lookup.py)

```python title="14_block_lookup.py"
