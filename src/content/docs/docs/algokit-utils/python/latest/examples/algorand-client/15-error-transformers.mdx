...
[← Back to Algorand Client](/docs/algokit-utils/python/latest/examples/algorand-client/)
...
```bash
cd examples
uv run python algorand_client/15_error_transformers.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/algorand_client/15_error_transformers.py)

```python title="15_error_transformers.py"
...
- [Client Instantiation](/docs/algokit-utils/python/latest/examples/algorand-client/01-client-instantiation/)
- [AlgoAmount Utility](/docs/algokit-utils/python/latest/examples/algorand-client/02-algo-amount/)
- [Signer Configuration](/docs/algokit-utils/python/latest/examples/algorand-client/03-signer-config/)
- [Suggested Params Configuration](/docs/algokit-utils/python/latest/examples/algorand-client/04-params-config/)
- [Account Manager](/docs/algokit-utils/python/latest/examples/algorand-client/05-account-manager/)
- [Send Payment](/docs/algokit-utils/python/latest/examples/algorand-client/06-send-payment/)
- [Send Asset Operations](/docs/algokit-utils/python/latest/examples/algorand-client/07-send-asset-ops/)
- [Send Application Operations](/docs/algokit-utils/python/latest/examples/algorand-client/08-send-app-ops/)
- [Create Transaction (Unsigned Transactions)](/docs/algokit-utils/python/latest/examples/algorand-client/09-create-transaction/)
- [Transaction Composer (Atomic Transaction Groups)](/docs/algokit-utils/python/latest/examples/algorand-client/10-transaction-composer/)
- [Asset Manager](/docs/algokit-utils/python/latest/examples/algorand-client/11-asset-manager/)
- [App Manager](/docs/algokit-utils/python/latest/examples/algorand-client/12-app-manager/)
- [App Deployer](/docs/algokit-utils/python/latest/examples/algorand-client/13-app-deployer/)
- [Client Manager](/docs/algokit-utils/python/latest/examples/algorand-client/14-client-manager/)
- **Error Transformers**
