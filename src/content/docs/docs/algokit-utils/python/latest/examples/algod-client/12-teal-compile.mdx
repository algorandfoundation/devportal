---
title: 'TEAL Compile and Disassemble'
description: 'This example demonstrates how to compile TEAL source code to bytecode and disassemble bytecode back to TEAL using the AlgodClient methods:'
sidebar:
  order: 12
---

[← Back to Algod Client](/docs/algokit-utils/python/latest/examples/algod-client/)
...
- teal*disassemble(bytecode) - Disassemble bytecode back to TEAL
  Note: Python SDK takes bytes for teal_compile (use .encode()), while TypeScript takes string. CompileResponse uses attribute access with hash* (underscore to avoid Python builtin).
  Prerequisites:
...
```bash
cd examples
uv run python algod_client/12_teal_compile.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/algod_client/12_teal_compile.py)

```python title="12_teal_compile.py"
...
- [Node Health and Status](/docs/algokit-utils/python/latest/examples/algod-client/01-node-health-status/)
- [Version and Genesis Information](/docs/algokit-utils/python/latest/examples/algod-client/02-version-genesis/)
- [Ledger Supply Information](/docs/algokit-utils/python/latest/examples/algod-client/03-ledger-supply/)
- [Account Information](/docs/algokit-utils/python/latest/examples/algod-client/04-account-info/)
- [Transaction Parameters](/docs/algokit-utils/python/latest/examples/algod-client/05-transaction-params/)
- [Send and Confirm Transaction](/docs/algokit-utils/python/latest/examples/algod-client/06-send-transaction/)
- [Pending Transactions](/docs/algokit-utils/python/latest/examples/algod-client/07-pending-transactions/)
- [Block Data](/docs/algokit-utils/python/latest/examples/algod-client/08-block-data/)
- [Asset Information](/docs/algokit-utils/python/latest/examples/algod-client/09-asset-info/)
- [Application Information](/docs/algokit-utils/python/latest/examples/algod-client/10-application-info/)
- [Application Boxes](/docs/algokit-utils/python/latest/examples/algod-client/11-application-boxes/)
- **TEAL Compile and Disassemble**
- [Transaction Simulation](/docs/algokit-utils/python/latest/examples/algod-client/13-simulation/)
- [Ledger State Deltas](/docs/algokit-utils/python/latest/examples/algod-client/14-state-deltas/)
- [Transaction Proof](/docs/algokit-utils/python/latest/examples/algod-client/15-transaction-proof/)
- [Light Block Header Proof](/docs/algokit-utils/python/latest/examples/algod-client/16-lightblock-proof/)
- [State Proof](/docs/algokit-utils/python/latest/examples/algod-client/17-state-proof/)
- [DevMode Timestamp Offset](/docs/algokit-utils/python/latest/examples/algod-client/18-devmode-timestamp/)
- [Sync Round Management](/docs/algokit-utils/python/latest/examples/algod-client/19-sync-round/)
