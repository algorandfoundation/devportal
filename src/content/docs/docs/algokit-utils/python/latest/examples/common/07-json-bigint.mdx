...
description: "This example demonstrates how Python handles large integers in JSON, which is simpler than JavaScript due to Python's native arbitrary-precision integers."
sidebar:
  order: 7
---
...
```bash
cd examples
uv run python common/07_json_bigint.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/common/07_json_bigint.py)

```python title="07_json_bigint.py"
