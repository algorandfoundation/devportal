---
title: 'Example'
description: 'Logger Type Example'
sidebar:
  order: 6
---
...
```bash
cd examples
uv run python common/06_logger.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/common/06_logger.py)

```python title="06_logger.py"
