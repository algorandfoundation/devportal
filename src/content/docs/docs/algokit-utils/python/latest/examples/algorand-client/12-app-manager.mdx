...
```bash
cd examples
uv run python algorand_client/12_app_manager.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/algorand_client/12_app_manager.py)

```python title="12_app_manager.py"
