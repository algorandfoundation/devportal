...
```bash
cd examples
uv run python transact/07_atomic_group.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/transact/07_atomic_group.py)

```python title="07_atomic_group.py"
...
- [Payment with Close](/docs/algokit-utils/python/latest/examples/transact/02-payment-close/)
