...
```bash
cd examples
uv run python algorand_client/08_send_app_ops.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/algorand_client/08_send_app_ops.py)

```python title="08_send_app_ops.py"
