...
description: "This example demonstrates how to close an account by transferring all remaining ALGO to another account using the close_remainder_to field in PaymentTransactionFields."
sidebar:
  order: 2
---

[← Back to Transactions](/docs/algokit-utils/python/latest/examples/transact/)
...
```bash
cd examples
uv run python transact/02_payment_close.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/transact/02_payment_close.py)

```python title="02_payment_close.py"
...
- [Payment Transaction](/docs/algokit-utils/python/latest/examples/transact/01-payment-transaction/)
- **Payment with Close**
- [Asset Create](/docs/algokit-utils/python/latest/examples/transact/03-asset-create/)
- [Asset Transfer](/docs/algokit-utils/python/latest/examples/transact/04-asset-transfer/)
- [Asset Freeze](/docs/algokit-utils/python/latest/examples/transact/05-asset-freeze/)
- [Asset Clawback](/docs/algokit-utils/python/latest/examples/transact/06-asset-clawback/)
- [Atomic Transaction Group](/docs/algokit-utils/python/latest/examples/transact/07-atomic-group/)
- [Atomic Swap](/docs/algokit-utils/python/latest/examples/transact/08-atomic-swap/)
- [Single Signature](/docs/algokit-utils/python/latest/examples/transact/09-single-sig/)
- [Multisig](/docs/algokit-utils/python/latest/examples/transact/10-multisig/)
- [Logic Signature](/docs/algokit-utils/python/latest/examples/transact/11-logic-sig/)
- [Fee Calculation](/docs/algokit-utils/python/latest/examples/transact/12-fee-calculation/)
- [Encoding/Decoding](/docs/algokit-utils/python/latest/examples/transact/13-encoding-decoding/)
- [Application Call](/docs/algokit-utils/python/latest/examples/transact/14-app-call/)
