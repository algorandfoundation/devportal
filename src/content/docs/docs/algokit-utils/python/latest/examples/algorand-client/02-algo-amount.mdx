...
```bash
cd examples
uv run python algorand_client/02_algo_amount.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/algorand_client/02_algo_amount.py)

```python title="02_algo_amount.py"
...
- [Error Transformers](/docs/algokit-utils/python/latest/examples/algorand-client/15-error-transformers/)
