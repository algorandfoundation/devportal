...
description: 'This example demonstrates how to encode and decode tuples using TupleType:'
sidebar:
  order: 7
---
...
```bash
cd examples
uv run python abi/07_tuple_type.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/abi/07_tuple_type.py)

```python title="07_tuple_type.py"
