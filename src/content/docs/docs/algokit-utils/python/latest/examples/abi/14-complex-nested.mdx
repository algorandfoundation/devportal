...
```bash
cd examples
uv run python abi/14_complex_nested.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/abi/14_complex_nested.py)

```python title="14_complex_nested.py"
