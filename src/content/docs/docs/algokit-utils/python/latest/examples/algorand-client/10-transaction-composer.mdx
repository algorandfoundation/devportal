...
```bash
cd examples
uv run python algorand_client/10_transaction_composer.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/algorand_client/10_transaction_composer.py)

```python title="10_transaction_composer.py"
