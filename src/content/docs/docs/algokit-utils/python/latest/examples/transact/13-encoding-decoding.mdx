...
```bash
cd examples
uv run python transact/13_encoding_decoding.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/transact/13_encoding_decoding.py)

```python title="13_encoding_decoding.py"
