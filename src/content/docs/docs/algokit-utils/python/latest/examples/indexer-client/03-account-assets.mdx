...
description: "This example demonstrates how to query account asset holdings using the IndexerClient lookup_account_assets() and lookup_account_created_assets() methods."
sidebar:
  order: 3
---
...
This example demonstrates how to query account asset holdings using the IndexerClient lookup_account_assets() and lookup_account_created_assets() methods.
 Prerequisites:
...
```bash
cd examples
uv run python indexer_client/03_account_assets.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/indexer_client/03_account_assets.py)

```python title="03_account_assets.py"
