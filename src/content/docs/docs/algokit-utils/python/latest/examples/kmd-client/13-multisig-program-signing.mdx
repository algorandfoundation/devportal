...
description: "This example demonstrates how to sign programs with multisig using the KMD sign_multisig_program() method. It shows:"
sidebar:
  order: 13
---
...
```bash
cd examples
uv run python kmd_client/13_multisig_program_signing.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/kmd_client/13_multisig_program_signing.py)

```python title="13_multisig_program_signing.py"
