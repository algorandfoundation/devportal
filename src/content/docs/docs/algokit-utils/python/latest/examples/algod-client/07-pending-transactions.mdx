...
description: 'This example demonstrates how to query pending transactions in the transaction pool using pending_transactions() and pending_transactions_by_address(). Pending transactions are those that have been submitted but not yet confirmed in a block.'
sidebar:
  order: 7
---
...
```bash
cd examples
uv run python algod_client/07_pending_transactions.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/algod_client/07_pending_transactions.py)

```python title="07_pending_transactions.py"
