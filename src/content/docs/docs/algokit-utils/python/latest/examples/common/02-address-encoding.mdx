...
description: 'This example demonstrates how to encode and decode addresses between different formats and compute application addresses:'
sidebar:
  order: 2
---
...
```bash
cd examples
uv run python common/02_address_encoding.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/common/02_address_encoding.py)

```python title="02_address_encoding.py"
