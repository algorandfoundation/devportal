...
```bash
cd examples
uv run python algod_client/16_lightblock_proof.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/algod_client/16_lightblock_proof.py)

```python title="16_lightblock_proof.py"
