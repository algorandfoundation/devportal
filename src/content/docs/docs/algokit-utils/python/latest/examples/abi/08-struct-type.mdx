...
description: 'This example demonstrates how to encode and decode named structs using StructType:'
sidebar:
  order: 8
---
...
```bash
cd examples
uv run python abi/08_struct_type.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/abi/08_struct_type.py)

```python title="08_struct_type.py"
