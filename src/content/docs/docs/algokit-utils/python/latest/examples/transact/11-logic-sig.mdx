...
```bash
cd examples
uv run python transact/11_logic_sig.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/transact/11_logic_sig.py)

```python title="11_logic_sig.py"
