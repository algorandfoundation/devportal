...
description: 'This example demonstrates how to encode and decode variable-length arrays using DynamicArrayType:'
sidebar:
  order: 6
---
...
```bash
cd examples
uv run python abi/06_dynamic_array.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/abi/06_dynamic_array.py)

```python title="06_dynamic_array.py"
