...
```bash
cd examples
uv run python algod_client/14_state_deltas.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/algod_client/14_state_deltas.py)

```python title="14_state_deltas.py"
