...
description: "This example demonstrates how to retrieve node version information and genesis configuration using the AlgodClient methods: versions() and genesis()."
sidebar:
  order: 2
---
...
```bash
cd examples
uv run python algod_client/02_version_genesis.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/algod_client/02_version_genesis.py)

```python title="02_version_genesis.py"
