...
```bash
cd examples
uv run python algorand_client/06_send_payment.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/algorand_client/06_send_payment.py)

```python title="06_send_payment.py"
