...
description: "This example demonstrates how to retrieve application information using the AlgodClient method: application_by_id()"
sidebar:
  order: 10
---
...
```bash
cd examples
uv run python algod_client/10_application_info.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/algod_client/10_application_info.py)

```python title="10_application_info.py"
