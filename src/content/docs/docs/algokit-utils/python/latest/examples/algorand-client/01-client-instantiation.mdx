...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/algorand_client/01_client_instantiation.py)

```python title="01_client_instantiation.py"
