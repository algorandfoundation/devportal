...
```bash
cd examples
uv run python abi/12_avm_types.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/abi/12_avm_types.py)

```python title="12_avm_types.py"
