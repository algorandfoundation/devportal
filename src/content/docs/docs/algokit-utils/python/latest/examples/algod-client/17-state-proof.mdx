...
```bash
cd examples
uv run python algod_client/17_state_proof.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/algod_client/17_state_proof.py)

```python title="17_state_proof.py"
