...
```bash
cd examples
uv run python abi/10_bool_packing.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/abi/10_bool_packing.py)

```python title="10_bool_packing.py"
