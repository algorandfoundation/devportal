...
```bash
cd examples
uv run python algorand_client/07_send_asset_ops.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/algorand_client/07_send_asset_ops.py)

```python title="07_send_asset_ops.py"
