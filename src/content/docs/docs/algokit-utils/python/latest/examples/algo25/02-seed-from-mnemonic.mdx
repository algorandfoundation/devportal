---
title: 'Seed from Mnemonic'
description: 'This example demonstrates how to use seed_from_mnemonic() to convert a 25-word Algorand mnemonic back to its original 32-byte seed. This is the reverse operation of mnemonic_from_seed().'
sidebar:
  order: 2
---
...
This example demonstrates how to use seed_from_mnemonic() to convert a 25-word Algorand mnemonic back to its original 32-byte seed. This is the reverse operation of mnemonic_from_seed().
Key concepts:
...
```bash
cd examples
uv run python algo25/02_seed_from_mnemonic.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/algo25/02_seed_from_mnemonic.py)

```python title="02_seed_from_mnemonic.py"
...
- [Mnemonic from Seed](/docs/algokit-utils/python/latest/examples/algo25/01-mnemonic-from-seed/)
- **Seed from Mnemonic**
