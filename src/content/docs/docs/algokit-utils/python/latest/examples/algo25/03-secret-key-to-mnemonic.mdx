---
title: "Secret Key to Mnemonic"
description: "This example demonstrates how to use secret_key_to_mnemonic() to convert a 64-byte Algorand secret key to a 25-word mnemonic."
sidebar:
  order: 3
---
...
This example demonstrates how to use secret_key_to_mnemonic() to convert a 64-byte Algorand secret key to a 25-word mnemonic.
 Key concepts:
...
```bash
cd examples
uv run python algo25/03_secret_key_to_mnemonic.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/algo25/03_secret_key_to_mnemonic.py)

```python title="03_secret_key_to_mnemonic.py"
