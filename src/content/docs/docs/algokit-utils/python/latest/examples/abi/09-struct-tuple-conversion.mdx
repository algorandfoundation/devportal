...
```bash
cd examples
uv run python abi/09_struct_tuple_conversion.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/abi/09_struct_tuple_conversion.py)

```python title="09_struct_tuple_conversion.py"
...
- [ARC-56 Storage Helpers](/docs/algokit-utils/python/latest/examples/abi/15-arc56-storage/)
