...
```bash
cd examples
uv run python transact/08_atomic_swap.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/transact/08_atomic_swap.py)

```python title="08_atomic_swap.py"
