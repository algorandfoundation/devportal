---
title: 'Block Headers Search'
description: 'This example demonstrates how to search for block headers using the IndexerClient search_for_block_headers() method.'
sidebar:
  order: 15
---
...
This example demonstrates how to search for block headers using the IndexerClient search_for_block_headers() method.
Prerequisites:
...
```bash
cd examples
uv run python indexer_client/15_block_headers.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/indexer_client/15_block_headers.py)

```python title="15_block_headers.py"
