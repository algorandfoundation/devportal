...
description: 'This example demonstrates how to retrieve asset information using the AlgodClient method: asset_by_id()'
sidebar:
  order: 9
---
...
```bash
cd examples
uv run python algod_client/09_asset_info.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/algod_client/09_asset_info.py)

```python title="09_asset_info.py"
