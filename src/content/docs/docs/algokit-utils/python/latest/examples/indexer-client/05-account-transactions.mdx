...
description: "This example demonstrates how to query an account's transaction history using the IndexerClient lookup_account_transactions() method."
sidebar:
  order: 5
---
...
This example demonstrates how to query an account's transaction history using the IndexerClient lookup_account_transactions() method.
Prerequisites:
...
```bash
cd examples
uv run python indexer_client/05_account_transactions.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/indexer_client/05_account_transactions.py)

```python title="05_account_transactions.py"
