---
title: 'MessagePack Encoding'
description: 'This example demonstrates encoding and decoding MessagePack data, which is used for Algorand transaction encoding.'
sidebar:
  order: 8
---
...
```bash
cd examples
uv run python common/08_msgpack.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/common/08_msgpack.py)

```python title="08_msgpack.py"
