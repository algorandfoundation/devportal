...
description: "This example demonstrates how to use mnemonic_from_seed() to convert a 32-byte seed into a 25-word Algorand mnemonic. The mnemonic uses BIP39-style word encoding where each word represents 11 bits of data."
sidebar:
  order: 1
---

[← Back to Mnemonic Utilities](/docs/algokit-utils/python/latest/examples/algo25/)

## Description

This example demonstrates how to use mnemonic_from_seed() to convert a 32-byte seed into a 25-word Algorand mnemonic. The mnemonic uses BIP39-style word encoding where each word represents 11 bits of data.
 Key concepts:
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/algo25/01_mnemonic_from_seed.py)

```python title="01_mnemonic_from_seed.py"
...
- **Mnemonic from Seed**
- [Seed from Mnemonic](/docs/algokit-utils/python/latest/examples/algo25/02-seed-from-mnemonic/)
- [Secret Key to Mnemonic](/docs/algokit-utils/python/latest/examples/algo25/03-secret-key-to-mnemonic/)
- [Master Derivation Key Functions](/docs/algokit-utils/python/latest/examples/algo25/04-master-derivation-key/)
- [Error Handling for Mnemonic Functions](/docs/algokit-utils/python/latest/examples/algo25/05-error-handling/)
