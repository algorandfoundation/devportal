...
description: 'This example demonstrates how to create multisig accounts using the KMD import_multisig() method.'
sidebar:
  order: 8
---
...
```bash
cd examples
uv run python kmd_client/08_multisig_setup.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/kmd_client/08_multisig_setup.py)

```python title="08_multisig_setup.py"
