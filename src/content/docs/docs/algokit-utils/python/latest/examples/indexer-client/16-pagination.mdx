...
```bash
cd examples
uv run python indexer_client/16_pagination.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-utils-py/blob/main/examples/indexer_client/16_pagination.py)

```python title="16_pagination.py"
