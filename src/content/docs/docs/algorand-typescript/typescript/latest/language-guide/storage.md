...
Global storage values are declared using the [GlobalState](/docs/algorand-typescript/typescript/latest/api/index/functions/globalstate/) function to create a [GlobalState](/docs/algorand-typescript/typescript/latest/api/index/type-aliases/globalstate/) proxy object.
...
We provide two different types for accessing box storage: [Box](/docs/algorand-typescript/typescript/latest/api/) and [BoxMap](/docs/algorand-typescript/typescript/latest/api/). We also expose raw operations via the [AVM ops](/docs/algorand-typescript/typescript/latest/language-guide/ops/) module.
