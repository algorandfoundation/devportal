...
We provide two different types for accessing box storage: [Box](functions/index.Box.html) and [BoxMap](functions/index.BoxMap.html). We also expose raw operations via the [AVM ops](/docs/algorand-typescript/typescript/latest/guides/lg-ops/) module.
