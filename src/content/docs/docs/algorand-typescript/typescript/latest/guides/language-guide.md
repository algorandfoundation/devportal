...
If you are interested in learning about the design of Algorand TypeScript, you can see our [Guiding Principles](/docs/algorand-typescript/typescript/latest/guides/guiding-principles/) for more detail, including the Architectural Decision Records (ADRs) which got us here.

## Table of Contents

- [Program Structure](/docs/algorand-typescript/typescript/latest/guides/lg-program-structure/)
- [Basic Types](/docs/algorand-typescript/typescript/latest/guides/lg-types/)
- [Storage](/docs/algorand-typescript/typescript/latest/guides/lg-storage/)
- [Ops](/docs/algorand-typescript/typescript/latest/guides/lg-ops/)
- [Inner Transactions](/docs/algorand-typescript/typescript/latest/guides/lg-itxns/)
