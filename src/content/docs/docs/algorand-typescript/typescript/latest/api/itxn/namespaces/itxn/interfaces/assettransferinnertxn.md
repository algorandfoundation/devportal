...
> `readonly` **assetAmount**: [`uint64`](/algorand-typescript/api/index/type-aliases/uint64/)
...
> `readonly` **assetCloseTo**: [`Account`](/algorand-typescript/api/index/type-aliases/account/)
...
> `readonly` **assetReceiver**: [`Account`](/algorand-typescript/api/index/type-aliases/account/)
...
> `readonly` **assetSender**: [`Account`](/algorand-typescript/api/index/type-aliases/account/)
...
> `readonly` **type**: [`AssetTransfer`](/algorand-typescript/api/index/enumerations/transactiontype/#assettransfer)
...
> `readonly` **xferAsset**: [`Asset`](/algorand-typescript/api/index/type-aliases/asset/)
