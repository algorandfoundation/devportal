...
> **BoxMap**\<`TKey`, `TValue`\>(`options`): [`BoxMap`](/algorand-typescript/api/index/type-aliases/boxmap/)\<`TKey`, `TValue`\>
...
[`BoxMap`](/algorand-typescript/api/index/type-aliases/boxmap/)\<`TKey`, `TValue`\>
