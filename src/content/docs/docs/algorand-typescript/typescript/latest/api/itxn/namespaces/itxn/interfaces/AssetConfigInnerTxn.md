...
> `readonly` **assetName**: [`bytes`](/algorand-typescript/api/index/type-aliases/bytes/)
...
> `readonly` **configAsset**: [`Asset`](/algorand-typescript/api/index/type-aliases/asset/)
...
> `readonly` **createdAsset**: [`Asset`](/algorand-typescript/api/index/type-aliases/asset/)
...
> `readonly` **type**: [`AssetConfig`](/algorand-typescript/api/index/enumerations/transactiontype/#assetconfig)
