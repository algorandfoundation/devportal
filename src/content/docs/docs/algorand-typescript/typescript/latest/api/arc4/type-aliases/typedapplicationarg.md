...
> **TypedApplicationArg**\<`TArg`\> = `TArg` _extends_ [`Transaction`](/algorand-typescript/api/gtxn/namespaces/gtxn/type-aliases/transaction/) ? [`GtxnToItxnFields`](/algorand-typescript/api/arc4/type-aliases/gtxntoitxnfields/)\<`TArg`\> : `TArg`
