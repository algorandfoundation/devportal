...
<Tabs>
  <TabItem label='npm'>```bash npm install @algorandfoundation/algokit-subscriber ```</TabItem>
  <TabItem label='pnpm'>```bash pnpm add @algorandfoundation/algokit-subscriber ```</TabItem>
  <TabItem label='yarn'>```bash yarn add @algorandfoundation/algokit-subscriber ```</TabItem>
</Tabs>
