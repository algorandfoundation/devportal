...
> `optional` **blockMetadata**: [`BlockMetadata`](/docs/algokit-subscriber/typescript/latest/api/types/interfaces/blockmetadata/)[]
...
> **subscribedTransactions**: [`SubscribedTransaction`](/docs/algokit-subscriber/typescript/latest/api/types/interfaces/subscribedtransaction/)[]
