---
title: 'ARC-28 Event Subscription'
description: 'This example demonstrates ARC-28 event parsing, filtering, and inspection.'
sidebar:
  order: 8
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-subscriber-ts/blob/main/examples/subscriber/08-arc28-events.ts)

```typescript title="08-arc28-events.ts"
/**
