---
title: "Batch Handling & Data Mappers"
description: "This example demonstrates mapper transforms with onBatch and on handler patterns."
sidebar:
  order: 10
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-subscriber-ts/blob/main/examples/subscriber/10-batch-and-mappers.ts)

```typescript title="10-batch-and-mappers.ts"
/**
