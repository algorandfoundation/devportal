---
title: 'Stateless Subscriptions'
description: 'This example demonstrates getSubscribedTransactions for serverless patterns.'
sidebar:
  order: 14
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-subscriber-ts/blob/main/examples/subscriber/14-stateless-subscriptions.ts)

```typescript title="14-stateless-subscriptions.ts"
/**
