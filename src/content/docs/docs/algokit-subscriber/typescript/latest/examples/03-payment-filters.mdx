...
description: 'This example demonstrates payment transaction filters.'
sidebar:
  order: 3
---
...
npx tsx 03-payment-filters.ts
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-subscriber-ts/blob/main/examples/subscriber/03-payment-filters.ts)

```typescript title="03-payment-filters.ts"
/**
