---
title: 'Asset Transfer Subscription'
description: 'This example demonstrates ASA lifecycle subscription.'
sidebar:
  order: 4
---
...
npx tsx 04-asset-transfer.ts
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-subscriber-ts/blob/main/examples/subscriber/04-asset-transfer.ts)
