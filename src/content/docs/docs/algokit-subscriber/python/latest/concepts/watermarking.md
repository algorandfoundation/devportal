...
This works through the use of the `watermark_persistence` parameter in [`AlgorandSubscriber`](/docs/algokit-subscriber/python/latest/guide/subscriber/) and `watermark` parameter in [`get_subscribed_transactions`](/docs/algokit-subscriber/python/latest/guide/subscriptions/):
