...
description: "Demonstrates getSubscribedTransactions for serverless patterns."
sidebar:
  order: 14
---
...
[View source on GitHub](https://github.com/algorandfoundation/algokit-subscriber-py/blob/main/examples/subscriber/14_stateless_subscriptions.py)

```python title="14_stateless_subscriptions.py"
