...
description: 'Demonstrates inner transaction subscription and parent-child relationships:'
sidebar:
  order: 9
---
...
uv run python 09_inner_transactions.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-subscriber-py/blob/main/examples/subscriber/09_inner_transactions.py)

```python title="09_inner_transactions.py"
