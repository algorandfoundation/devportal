...
description: 'Demonstrates file-backed watermark persistence across multiple polls:'
sidebar:
  order: 11
---
...
uv run python 11_watermark_persistence.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-subscriber-py/blob/main/examples/subscriber/11_watermark_persistence.py)

```python title="11_watermark_persistence.py"
