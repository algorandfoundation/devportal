...
description: 'Demonstrates ARC-28 event parsing, filtering, and inspection:'
sidebar:
  order: 8
---
...
uv run python 08_arc28_events.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-subscriber-py/blob/main/examples/subscriber/08_arc28_events.py)

```python title="08_arc28_events.py"
