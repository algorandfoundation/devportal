...
description: "Demonstrates mapper transforms with on_batch and on handler patterns:"
sidebar:
  order: 10
---
...
uv run python 10_batch_and_mappers.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-subscriber-py/blob/main/examples/subscriber/10_batch_and_mappers.py)

```python title="10_batch_and_mappers.py"
