...
description: 'Demonstrates lifecycle hooks and retry patterns.'
sidebar:
  order: 15
---
...
uv run python 15_lifecycle_hooks.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-subscriber-py/blob/main/examples/subscriber/15_lifecycle_hooks.py)

```python title="15_lifecycle_hooks.py"
