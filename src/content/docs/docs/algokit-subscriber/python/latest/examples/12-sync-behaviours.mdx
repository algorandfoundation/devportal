...
description: 'Demonstrates all 4 sync behaviours and maxRoundsToSync comparison:'
sidebar:
  order: 12
---
...
uv run python 12_sync_behaviours.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-subscriber-py/blob/main/examples/subscriber/12_sync_behaviours.py)

```python title="12_sync_behaviours.py"
