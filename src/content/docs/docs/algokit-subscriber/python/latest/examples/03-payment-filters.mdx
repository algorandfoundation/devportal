...
description: 'Demonstrates payment transaction filters:'
sidebar:
  order: 3
---
...
uv run python 03_payment_filters.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-subscriber-py/blob/main/examples/subscriber/03_payment_filters.py)

```python title="03_payment_filters.py"
