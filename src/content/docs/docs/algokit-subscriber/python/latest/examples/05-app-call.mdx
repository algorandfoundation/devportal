...
description: 'Demonstrates application call subscription with ABI method filtering:'
sidebar:
  order: 5
---
...
uv run python 05_app_call.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-subscriber-py/blob/main/examples/subscriber/05_app_call.py)

```python title="05_app_call.py"
