...
description: "Demonstrates continuous polling with start/stop and event handlers."
sidebar:
  order: 2
---
...
uv run python 02_continuous_subscriber.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-subscriber-py/blob/main/examples/subscriber/02_continuous_subscriber.py)

```python title="02_continuous_subscriber.py"
