...
description: "Demonstrates ASA lifecycle subscription:"
sidebar:
  order: 4
---
...
uv run python 04_asset_transfer.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-subscriber-py/blob/main/examples/subscriber/04_asset_transfer.py)

```python title="04_asset_transfer.py"
