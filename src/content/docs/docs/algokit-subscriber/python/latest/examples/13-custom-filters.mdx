...
description: 'Demonstrates custom filter predicates with multi-condition logic:'
sidebar:
  order: 13
---
...
uv run python 13_custom_filters.py
```

## Code

[View source on GitHub](https://github.com/algorandfoundation/algokit-subscriber-py/blob/main/examples/subscriber/13_custom_filters.py)

```python title="13_custom_filters.py"
