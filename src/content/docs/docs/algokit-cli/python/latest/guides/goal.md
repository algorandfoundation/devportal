...
AlgoKit goal command provides the user with a mechanism to run [goal cli](https://dev.algorand.co/algokit/algokit-cli/goal/) commands against the current [AlgoKit LocalNet](/docs/algokit-cli/python/latest/guides/localnet/).
...
For more details about the `AlgoKit goal` command, please refer to the [AlgoKit CLI reference documentation](/docs/algokit-cli/python/latest/#goal).
