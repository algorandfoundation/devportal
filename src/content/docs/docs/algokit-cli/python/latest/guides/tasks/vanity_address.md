...
Generate a vanity address with the keyword "ALGO" at the start of the address and store into a [wallet alias](/docs/algokit-cli/python/latest/guides/tasks/wallet/):
