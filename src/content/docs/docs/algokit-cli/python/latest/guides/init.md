...
For more details on workspaces and standalone projects, refer to the [AlgoKit Project documentation](/docs/algokit-cli/python/latest/guides/project/#workspaces-vs-standalone-projects).
