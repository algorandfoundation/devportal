...
- [Bootstrap](/docs/algokit-cli/python/latest/guides/project/bootstrap/) - Bootstrap AlgoKit project dependencies
- [Compile](/docs/algokit-cli/python/latest/guides/compile/) - Compile Algorand Python code
- [Completions](/docs/algokit-cli/python/latest/guides/completions/) - Install shell completions for AlgoKit
- [Deploy](/docs/algokit-cli/python/latest/guides/project/deploy/) - Deploy your smart contracts effortlessly to various networks
- [Dispenser](/docs/algokit-cli/python/latest/guides/dispenser/) - Fund your TestNet account with ALGOs from the AlgoKit TestNet Dispenser
- [Doctor](/docs/algokit-cli/python/latest/guides/doctor/) - Check AlgoKit installation and dependencies
- [Explore](/docs/algokit-cli/python/latest/guides/explore/) - Explore Algorand Blockchains using lora
- [Generate](/docs/algokit-cli/python/latest/guides/generate/) - Generate code for an Algorand project
- [Goal](/docs/algokit-cli/python/latest/guides/goal/) - Run the Algorand goal CLI against the AlgoKit Sandbox
- [Init](/docs/algokit-cli/python/latest/guides/init/) - Quickly initialize new projects using official Algorand Templates or community provided templates
- [LocalNet](/docs/algokit-cli/python/latest/guides/localnet/) - Manage a locally sandboxed private Algorand network
- [Project](/docs/algokit-cli/python/latest/guides/project/) - Manage an AlgoKit project workspace on your file system
- [Tasks](/docs/algokit-cli/python/latest/guides/tasks/) - Perform a variety of useful operations on the Algorand blockchain
...
- `--skip-version-check` Skips updated AlgoKit version checking and prompting for that execution, this can also be disabled [permanently on a given machine](/docs/algokit-cli/python/latest/#version-prompt) with `algokit config version-prompt disable`.

See also the [AlgoKit CLI Reference](/docs/algokit-cli/python/latest/), which details every command, sub-command and option.
