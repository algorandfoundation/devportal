...
- `--receiver`, -r: Receiver [alias](/docs/algokit-cli/python/latest/features/tasks/wallet/#add) or address to fund with TestNet ALGOs. This option is required.
...
For in-depth details, visit the [dispenser section](/docs/algokit-cli/python/latest/cli/#dispenser) in the AlgoKit CLI reference documentation.
