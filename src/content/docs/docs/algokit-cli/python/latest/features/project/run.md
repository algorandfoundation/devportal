...
To learn more about the `algokit project run` command, please refer to [run](/docs/algokit-cli/python/latest/cli/#run) in the AlgoKit CLI reference documentation.
