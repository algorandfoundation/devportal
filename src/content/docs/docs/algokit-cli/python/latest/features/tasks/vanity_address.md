...
Generate a vanity address with the keyword "ALGO" at the start of the address and store into a [wallet alias](/docs/algokit-cli/python/latest/features/tasks/wallet/):
...
For in-depth details, visit the [vanity-address section](/docs/algokit-cli/python/latest/cli/#vanity-address) in the AlgoKit CLI reference documentation.
