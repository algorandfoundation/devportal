...
- [link](/docs/algokit-cli/python/latest/features/project/link/) - Powerful feature designed to streamline the integration between `frontend` and `contract` projects
- [list](/docs/algokit-cli/python/latest/features/project/list/) - Enumerate all projects within an AlgoKit workspace.
- [run](/docs/algokit-cli/python/latest/features/project/run/) - Define custom commands and manage their execution via `algokit` cli.
