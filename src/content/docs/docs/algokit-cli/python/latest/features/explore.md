...
The following three commands are all equivalent and will open lora pointing to the local [AlgoKit LocalNet](/docs/algokit-cli/python/latest/features/localnet/) instance:
...
To learn more about the `algokit explore` command, please refer to [explore](/docs/algokit-cli/python/latest/cli/#explore) in the AlgoKit CLI reference documentation.
