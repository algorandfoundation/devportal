...
1. Development
   ...
   3. **Verify** the TEAL Templates maintain [output stability](/docs/algokit-cli/python/latest/concepts/output-stability/) and any other static code quality checks
2. Deployment
...
![Smart Contract Development Lifecycle](/docs/algokit-cli/python/latest/images/lifecycle.jpg)
...
- [AlgoKit Guiding Principles](/docs/algokit-cli/python/latest/features/overview/#Guiding-Principles) - specifically:
