...
- Given that copier is being considered as a backbone for generators feature, drawbacks outlined for hosting templates on monorepos in the [previous adr](/docs/algokit-cli/python/latest/architecture-decisions/2023-06-06_frontend-templates/#option-1-monolithic-template) apply here as well.
