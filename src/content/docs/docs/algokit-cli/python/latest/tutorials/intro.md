...
[![Learn How to Build on Algorand in 10 Minutes](/docs/algokit-cli/python/latest/images/algokit-intro-video-thumbnail.jpg)](https://www.youtube.com/embed/dow6U8DxOGc)
...
- [Docker](https://docs.docker.com/desktop/install/mac-install/) (or [Podman](https://podman.io/getting-started/installation/), see [details](/docs/algokit-cli/python/latest/features/localnet/#podman-support))
...
AlgoKit supports using a [local version of the Algorand blockchain](/docs/algokit-cli/python/latest/features/localnet/). To start an instance of this LocalNet run the following command from the terminal:
...
![Docker Desktop LocalNet Instance](/docs/algokit-cli/python/latest/images/localnet.png)
...
![AlgoKit Playground Contract](/docs/algokit-cli/python/latest/images/algokitplayground.png)
...
![CodeTour Play Button](/docs/algokit-cli/python/latest/images/algokitcodetour.png)
...
- To get the most out of `AlgoKit`, we recommend to get started with learning more about AlgoKit and what you can do with it by checking out our extensive [AlgoKit CLI documentation](/docs/algokit-cli/python/latest/features/overview/).
...
- To learn more about the commands demonstrated in this tutorial, refer to [`init`](/docs/algokit-cli/python/latest/features/init/) and [`project`](/docs/algokit-cli/python/latest/features/project/) to get a comprehensive understanding of their further capabilities.
- If you'd like to learn more on structuring your `AlgoKit Project` as a monorepo, refer to `workspace` mode as described in [`init`](/docs/algokit-cli/python/latest/features/init/#workspaces-vs-standalone-projects). You can also pass the `--no-workspace` flag to setup a standalone algokit project, if preferred.
- If you'd like to **create your own** `AlgoKit` template, refer to the [template tutorial](/docs/algokit-cli/python/latest/tutorials/algokit-template/).
