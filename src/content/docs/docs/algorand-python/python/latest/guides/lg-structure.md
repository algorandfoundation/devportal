...
[logic signatures](), and [compile-time constant code and values](/docs/algorand-python/python/latest/guides/lg-modules/).
...
\\\\
[some inner transaction types](/docs/algorand-python/python/latest/guides/lg-transactions/#inner-transaction-objects-cannot-be-passed-to-or-returned-from-subroutines)
).
...
including reading directly from the transaction arguments via [`Txn`](/docs/algorand-python/python/latest/api/api-algopyop/#algopy.op.Txn). This makes
...
- `self.counter` will be stored in the application’s [Global State](/docs/algorand-python/python/latest/guides/lg-storage/#global-state).
...
See the [ARC-4 section](/docs/algorand-python/python/latest/guides/lg-arc4/) of this language guide for more info on the above.
