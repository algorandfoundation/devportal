...
You can write compile-time constant code at a module level and then use them in place of [Python built-in literal types](/docs/algorand-python/python/latest/guides/lg-types/#python-built-in-types).
