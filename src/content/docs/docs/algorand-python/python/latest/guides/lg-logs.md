...
This `log` method is a superset of the [AVM `log` method](/docs/algorand-python/python/latest/guides/lg-ops/) that adds extra functionality:
...
If you want to emit ARC-28 events in the logs then there is a [purpose-built function for that](/docs/algorand-python/python/latest/guides/lg-arc28/).
