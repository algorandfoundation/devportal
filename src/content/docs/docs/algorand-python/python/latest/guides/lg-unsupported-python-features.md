...
[assert statements](/docs/algorand-python/python/latest/guides/lg-errors/).
...
Module level values are only allowed to be [constants](/docs/algorand-python/python/latest/guides/lg-modules/#module-constants). No
...
If you do have need of such a thing, take a look at [gload_bytes](/docs/algorand-python/python/latest/api/api-algopyop/#algopy.op.gload_bytes)
or [gload_uint64](/docs/algorand-python/python/latest/api/api-algopyop/#algopy.op.gload_uint64) if the contracts are within the same transaction,
otherwise [AppGlobal.get_ex_bytes](/docs/algorand-python/python/latest/api/api-algopyop/#algopy.op.AppGlobal.get_ex_bytes)
and [AppGlobal.get_ex_uint64](/docs/algorand-python/python/latest/api/api-algopyop/#algopy.op.AppGlobal.get_ex_uint64).
...
[arc4.Struct](/docs/algorand-python/python/latest/api/api-algopyarc4/#algopy.arc4.Struct)) don’t currently allow for inheritance. Member functions there
