...
the current method via [local variables and subroutine params](/docs/algorand-python/python/latest/guides/lg-structure/#subroutines).
...
1. Assigning any [Algorand Python typed](/docs/algorand-python/python/latest/guides/lg-types/) value to an instance variable (e.g. `self.value = UInt64(3)`).
   - Use this approach if you just require a terse API for getting and setting a state value
2. Using an instance of `GlobalState`, which gives [some extra features](/docs/algorand-python/python/latest/api/api-algopy/#algopy.GlobalState) to understand
...
We provide two different types for accessing box storage: [Box](/docs/algorand-python/python/latest/api/api-algopy/#algopy.Box), and [BoxMap](/docs/algorand-python/python/latest/api/api-algopy/#algopy.BoxMap). We also expose raw operations via the [AVM ops](/docs/algorand-python/python/latest/guides/lg-ops/) module.
...
If none of these abstractions suit your needs, you can use the box storage [AVM ops](/docs/algorand-python/python/latest/guides/lg-ops/) to interact with box storage. These ops match closely to the opcodes available on the AVM.
...
To use scratch storage you need to [register the scratch storage that you want to use](/docs/algorand-python/python/latest/guides/lg-structure/#contract-class-configuration) and then you can use the scratch storage [AVM ops](/docs/algorand-python/python/latest/guides/lg-ops/).
