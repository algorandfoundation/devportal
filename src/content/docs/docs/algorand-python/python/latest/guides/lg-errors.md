...
Assertions allow you to immediately fail a smart contract if a [Boolean statement or value](/docs/algorand-python/python/latest/guides/lg-types/#bool) evaluates to `False`. If an assertion fails, it immediately stops the execution of the contract and marks the call as a failure.
...
For more details see [Unsupported Python features](/docs/algorand-python/python/latest/guides/lg-unsupported-python-features/#raise-try-except-finally).
