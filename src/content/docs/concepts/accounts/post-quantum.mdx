...
- [FIPS 206 (Initial Public Draft): FN-DSA](https://csrc.nist.gov/pubs/fips/206/ipd): NIST's draft standard derived from Falcon; Algorand uses a deterministic Falcon variant
