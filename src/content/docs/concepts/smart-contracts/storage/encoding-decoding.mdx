...
<Tabs syncKey='lang'>
  ...
  <TabItem label='Python' icon='seti:python'>
    ```javascript const encoded_str = 'SGksIEknbSBkZWNvZGVkIGZyb20gYmFzZTY0' const decoded_str =
    base64.b64decode(encoded_str).decode("utf-8") printf(decoded_str) ``` [Snippet
