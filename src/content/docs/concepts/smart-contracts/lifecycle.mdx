...
<LinkCard
  title='Algorand Python Extension'
  href='https://marketplace.visualstudio.com/items?itemName=AlgorandFoundation.algorand-python-vscode'
  description='Install the Algorand Python VS Code extension (currently in `beta`)'
/>

#### Algorand TypeScript Extension
...
- Quick fixes for common TypeScript issues, helping you learn the Algorand TypeScript language as you build
...
<LinkCard
  title='Algorand TypeScript Extension'
  href='https://marketplace.visualstudio.com/items?itemName=AlgorandFoundation.algorand-typescript-vscode'
  description='Install the Algorand TypeScript VS Code extension (currently in `beta`)'
/>

:::tip
Both extensions are currently in `beta` and actively being improved. They complement the AlgoKit development workflow by catching common mistakes early and providing contextual guidance directly in your editor.
:::
...
<YouTube id='zlg6AizzQhw' title='Algorand Smart Contract Testing' />
