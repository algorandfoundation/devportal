...
:::caution[Use Algorand TypeScript, not TEALScript]
Algorand TypeScript is the supported way to write Algorand smart contracts in TypeScript. TEALScript is its predecessor and is not recommended for new projects: `algokit init -t typescript` scaffolds Algorand TypeScript, and existing TEALScript contracts should be moved across using the [TEALScript to Algorand TypeScript migration guide](/docs/algorand-typescript/typescript/latest/migration-guides#migrating-tealscript-to-algorand-typescript-10).
:::
...
<LinkCard
  ...
  href='https://marketplace.visualstudio.com/items?itemName=AlgorandFoundation.algorand-typescript-vscode'
/>
