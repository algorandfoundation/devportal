...
:::caution[Use Algorand Python, not PyTEAL or Beaker]
Algorand Python is the supported way to write Algorand smart contracts in Python. PyTEAL, and the Beaker framework built on top of it, are legacy paths: the official [Beaker AlgoKit template is archived](https://github.com/algorandfoundation/algokit-beaker-default-template) in favour of Algorand Python, and AlgoKit's templates, typed clients, and debugging tools target Algorand Python. Do not use PyTEAL, Beaker, or the community-maintained [Tealish](https://tealish.tinyman.org) for new projects or as reference implementations.
:::
...
<LinkCard
  title='Algorand Python VS Code Extension'
  description='This extension brings language server powered capabilities to your smart contract authoring experience in VSCode'
  href='https://marketplace.visualstudio.com/items?itemName=AlgorandFoundation.algorand-python-vscode'
/>
