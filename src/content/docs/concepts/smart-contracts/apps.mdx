...
- `UpdateApplication`: Transaction to update the logic of an application. From consensus v42, it can also change the application's extra program pages and global state schema.
