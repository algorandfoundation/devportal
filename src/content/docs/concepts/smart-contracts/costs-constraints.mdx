...
| Type             | Constraint                                                                                                                                                                                                                                                    |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Logic Signatures | Max size: 1000 bytes for logic signatures (consensus parameter LogicSigMaxSize). Components: The bytecode plus the length of all arguments. Programs up to 16,000 bytes are possible for an [additional fee](/concepts/transactions/fees#larger-transactions) |
...
| Max Size of Compiled TEAL Code | The maximum size of compiled TEAL code combined with arguments is 1000 bytes. This limit is defined by the consensus parameter `LogicSigMaxSize`. Programs up to 16,000 bytes are possible for an [additional fee](/concepts/transactions/fees#larger-transactions)                                                                                                |
