...
| Name                                                   | Value      | Variable        | Note                                                                                                                                 |
| ------------------------------------------------------ | ---------- | --------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| Max size of compiled TEAL code combined with arguments | 1000 bytes | LogicSigMaxSize | Programs up to 16000 bytes (MaxAbsoluteLogicSigProgramSize) for an [additional fee](/concepts/transactions/fees#larger-transactions) |
