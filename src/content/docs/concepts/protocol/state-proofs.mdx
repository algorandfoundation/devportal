...
import blockIntervalCommitment from '@images/sp_block_interval_commitment.png';
import transactionCommitment from '@images/sp_transaction_commitment.png';
...
On round 512 (=768 - 256), every participating node would create a participation commitment for the top N online accounts, composed of their public state proof keys and relative online stake. When a node is elected to propose a block through consensus, it includes this commitment in the block header.
On round 769, every participating node executes the following steps for each online account it manages:
...
<Image src={transactionCommitment} alt='Image of Transaction Commitment' />
...
<Image src={blockIntervalCommitment} alt='Image of Block Interval Commitment' />
