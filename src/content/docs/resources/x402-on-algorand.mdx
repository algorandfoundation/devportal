...
```bash
npm install @x402/core @x402/fetch @x402/avm @algorandfoundation/algokit-utils@10.0.0-alpha.42 dotenv
```
...
```bash
npm install @x402/core @x402/avm @x402/hono hono @hono/node-server dotenv
```

#### Server config

Similarly, copy the `tsconfig.json` from [Client config](#client-config).
