...
```bash
pnpm add @x402/core @x402/fetch @x402/avm @algorandfoundation/algokit-utils@10.0.0-alpha.42 dotenv
```
...
:::note
If pnpm prompts about build scripts, run `pnpm approve-builds` to allow native builds (required for esbuild).
:::
