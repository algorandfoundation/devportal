...
By default, enabling Algorand P2P will only makes outbound connections from your node to Repeaters on the mesh. The Repeaters you connect to will see your public IP. Previously, only Repeaters saw it. You can allow inbound connections if you choose, but it is not required. This change improves openness but may not suit everyone running a node from home.
