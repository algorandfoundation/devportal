...
<Aside type='tip' title='How to configure P2P on FUNC'>
  Please see this [guide](/resources/p2p-func) if you need to configure P2P and are using
  [FUNC](https://github.com/GalaxyPay/func) to manage your node.
</Aside>
