...
Algokey is a command line utility for generating, exporting and importing keys. The tool can be used to sign single and multi-signature transactions as well.
See [algokey](https://developer.algorand.org/docs/clis/algokey/algokey/) documentation for more details.
