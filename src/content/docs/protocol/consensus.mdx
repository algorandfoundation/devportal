...
import blockProposal from '@images/algorand_consensus-block-proposal.png';
import certifyVote from '@images/algorand_consensus-certify-vote.png';
import softVote2 from '@images/algorand_consensus-soft-vote-2.png';
import softVote from '@images/algorand_consensus-soft-vote.png';
...
<Image src={blockProposal} alt='Image of block proposal' />

Figure: Block Proposal
...
<Image src={softVote} alt='Image of soft vote part 1' />

Figure: Soft Vote Part 1
...
<Image src={softVote2} alt='Image of soft vote part 2' />

Figure: Soft Vote Part 2
...
<Image src={certifyVote} alt='Image of certify vote' />
