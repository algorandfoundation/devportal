...
> Proposals requesting a large amount of funds **MUST BE** split into a milestone-based plan. See [Submit a proposal](../arc-0034#submit-a-proposal)
...
> For milestone-based grants, please also refer to the [Submit a proposal section](../arc-0034#submit-a-proposal)
