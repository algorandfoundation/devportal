...
# Extend [ARC-4](../arc-0004) to add `read-only` annotation to methods

The following document introduces a convention for creating methods (as described in [ARC-4](../arc-0004)) which don't mutate state.
