...
A smart contract NFT that is compliant with this standard must implement the interface detection standard defined in [ARC-73](../arc-0073).
...
All methods in this and other interfaces defined throughout this standard that are marked as `readonly` MUST be read-only as defined by [ARC-22](../arc-0022).
...
- the JSON Metadata File Schema defined in [ARC-3](../arc-0003).
- the standard for declaring traits defined in [ARC-16](../arc-0016).
