...
Contains supplemental information about [ARC-0004](../arc-0004) ABI methods, each record represents a single method in the [ARC-0004](../arc-0004) contract. The record key should be the corresponding ABI signature.

NOTE: Ideally this information would be part of the [ARC-0004](../arc-0004) ABI specification.
...
NOTE: This property is made obsolete by [ARC-0022](../arc-0022) but is included as it is currently
