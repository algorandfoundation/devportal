...
Accepts the inputs to [ARC-0001](../arc-0001#interface-signtxnsfunction)'s / [ARC-0005](../arc-0005#interface-signtxnsfunction)'s `signTxns`, and produces the output of [ARC-0007](../arc-0007#interface-posttxnsfunction)'s `postTxns`.
...
Errors are handled exactly as specified by [ARC-0001](../arc-0001#error-standards) and [ARC-0007](../arc-0007#error-standard)
