...
Accepts the inputs to [ARC-0001](../arc-0001#interface-signtxnsfunction)'s / [ARC-0005](./arc-0005.md#interface-signtxnsfunction)'s `signTxns`, and produces the output of [ARC-0007](./arc-0007.md#interface-posttxnsfunction)'s `postTxns`.
...
* `WalletTransaction` is as specified by [ARC-0005](../arc-0005#interface-wallettransaction).
* `PostTxnsResult` is as specified by [ARC-0007](../arc-0007#interface-posttxnsfunction).

Errors are handled exactly as specified by [ARC-0001](../arc-0001#error-standards) and [ARC-0007](./arc-0007.md#error-standard)
