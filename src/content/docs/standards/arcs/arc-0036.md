...
If `filters` wants to be added on top of fields [ARC-16](../arc-0016) `traits` and `filters` should be inside the `properties` object. (eg: [Example above](../arc-0036#example-of-an-nft-that-has-traits--filters))
