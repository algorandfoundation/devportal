...
The [`WalletTransaction`](../arc-0001#interface-wallettransaction) and [`SignTxnOpts`](../arc-0001#interface-signtxnsopts) types are defined in [ARC-1](../arc-0001).
...
> For more information, see [ARC-1 - Syntax and Interfaces](../arc-0001#syntax-and-interfaces) and [ARC-1 - Semantic and Security Requirements](../arc-0001#semantic-and-security-requirements).
