...
It is strongly recommended to read and understand the entirety of [ARC-1](../arc-0001) before reading this ARC.
...
The [`WalletTransaction`](../arc-0001#interface-wallettransaction) and [`SignTxnOpts`](./arc-0001.md#interface-signtxnsopts) types are defined in [ARC-1](../arc-0001).
...
> For more information, see [ARC-1 - Syntax and Interfaces](../arc-0001#syntax-and-interfaces) and [ARC-1 - Semantic and Security Requirements](./arc-0001.md#semantic-and-security-requirements).
...
[`SignedTxnStr`](../arc-0001#interface-signedtxnstr) type is defined in [ARC-1](../arc-0001).
...
All request failures **MUST** use the error codes defined in [ARC-1 - Error Standards](../arc-0001#error-standards).
