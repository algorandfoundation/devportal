...
A property `algorand` attached to the `window` browser object, with all the features defined in [ARC-0010](../arc-0010#specification).
...
With the specifications and semantics for each function as stated in [ARC-0010](../arc-0010#specification).
