...
For example, an [ARC-16](/arc-standards/arc-0016) NFT asset that also follows the [ARC-3](/arc-standards/arc-0003) metadata conventions could expose a URI such as:
