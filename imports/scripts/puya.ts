...
await processDirectories([
  {
    ...
    dest:
      scriptLocation + '/../../src/content/docs/algokit/languages/typescript',
  },
]);
...
await processFile([
  {
    src: scriptLocation + '/../repos/puya-ts/docs/api/README.md',
    transformations: [
      convertH1ToFrontmatter,
      stripLinkExtensions,
      replaceTitleColon,
    ...
    dest:
      scriptLocation +
      '/../../src/content/docs/algokit/languages/typescript/api.md',
  },
]);

await processFile([
  {
    src: scriptLocation + '/../repos/puya-ts/docs/cli.md',
    transformations: [
      convertH1ToFrontmatter,
      stripLinkExtensions,
      replaceTitleColon,
    ...
    dest:
      scriptLocation +
      '/../../src/content/docs/algokit/languages/typescript/cli.md',
  },
]);
...
await processFile([
  {
    ...
    dest:
      scriptLocation +
      '/../../src/content/docs/algokit/languages/typescript/overview.md',
  },
]);
